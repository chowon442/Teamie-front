import {
  ...
  _ as be,
  a as I,
} from './DocsRenderer-PQXLIZUC-CPxX7nN0.js';
import { a as p, R as v } from './iframe-Dbg8MXT6.js';
import './react-18-CoIg_Xz7.js';
import './jsx-runtime-CkV8dy2C.js';
var ve = I({
...
var $ = function (r, l, s) {
    return (l === void 0 && (l = 0), s === void 0 && (s = 1), r > s ? s : r < l ? l : r);
  },
  O = function (r) {
    return 'touches' in r;
  },
      ...
      a = p.useMemo(
        function () {
          ...
          function b(y) {
            ...
            (x(m ? 'touchmove' : 'mousemove', f), x(m ? 'touchend' : 'mouseup', g));
          }
          return [
            function (y) {
              var m = y.nativeEvent,
  ...
  w = function (r, l, s) {
    return (l === void 0 && (l = 0), s === void 0 && (s = Math.pow(10, l)), Math.round(s * r) / s);
  },
...
var Oe = typeof window < 'u' ? p.useLayoutEffect : p.useEffect,
  ...
  Ne = function (r) {
    ...
    return v.createElement(
      ...
      v.createElement(ee, { hue: a.h, onChange: o, className: 'react-colorful__last-control' })
    );
  },
  Re = {
    defaultColor: '000',
  ...
  ze = function (r) {
    ...
    return v.createElement(
      ...
      v.createElement(
        ...
        v.createElement(D, { className: 'react-colorful__alpha-pointer', left: s.a, color: z(s) })
      )
    );
  },
  le = function (r) {
  ...
  He = { defaultColor: 'hsla(0, 0%, 0%, 1)', toHsva: ke, fromHsva: z, equal: ne },
  Ie = function (r) {
  ...
  ue = ((r) => ((r.RGB = 'rgb'), (r.HSL = 'hsl'), (r.HEX = 'hex'), r))(ue || {}),
  q = Object.values(ue),
  ...
  j = { hex: 'transparent', rgb: 'rgba(0, 0, 0, 0)', hsl: 'hsla(0, 0%, 0%, 0)' },
  ie = (r) => {
    let l = r?.match(We);
    if (!l) return [0, 0, 0, 1];
    let [, s, h, u, d = 1] = l;
  ...
  nr = (r, l, s) => {
    ...
    let d = p.useMemo(
      ...
      e = p.useCallback(
        (n) => {
          n?.valid &&
            (d.some((t) => t && t[s] && H(t[s] || '') === H(n[s] || '')) || u((t) => t.concat(n)));
        },
        [s, d]
      );
                ...
                b.map((x, N) =>
                  v.createElement(
                    A,
                    {
                      key: `${x?.value || N}-${N}`,
                      hasChrome: !1,
                      tooltip: v.createElement(Te, { note: x?.keyword || x?.value || '' }),
                    },
                    v.createElement(Y, {
                      value: x?.[f] || '',
