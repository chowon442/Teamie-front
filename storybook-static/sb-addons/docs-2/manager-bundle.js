    ...
    var ia = __STORYBOOK_API__,
      {
        ...
        experimental_useUniversalStore: wa,
        internal_fullStatusStore: Pa,
    ...
    function L(e) {
      ...
      return (
        (L = function (r) {
          ...
          function a() {
            return ce(r, arguments, N(this).constructor);
          }
          return (
...
`,
    ...
    var h = (function (e) {
      ...
      function t(r) {
        for (var a, n = arguments.length, o = new Array(n > 1 ? n - 1 : 0), s = 1; s < n; s++)
          o[s - 1] = arguments[s];
        return ((a = e.call(this, he.apply(void 0, [be[r]].concat(o))) || this), de(a));
      }
      return t;
    })(L(Error));
    function M(e) {
    ...
    function S(e) {
      if (typeof e != 'string') throw new h(3);
      var t = ye(e);
      if (t.match(ve))
        return {
      ...
      var f = we.exec(t.substring(0, 50));
      if (f) {
    ...
    function y(e) {
      if (typeof e != 'object') throw new h(8);
      if (Fe(e)) return F(e);
      if (Oe(e)) return q(e);
      if (je(e)) return Ie(e);
      if (He(e)) return Re(e);
    ...
    var Ze = m(Ue),
      ...
      rt = ({ isLoading: e, error: t, language: r, code: a, dark: n, format: o = !0, ...s }) => {
        ...
        if (t) return u.createElement(Xe, null, t);
