try {
  (() => {
    ...
    var Oe = {
      NODE_ENV: 'production',
      NODE_PATH: [
        'D:\\coding\\Teamie-front\\node_modules\\.pnpm\\storybook@9.0.18_@testing-library+dom@10.4.0_prettier@3.6.2\\node_modules\\storybook\\bin\\node_modules',
    ...
    var sf = __STORYBOOK_TYPES__,
      { Addon_TypesEnum: Lr } = __STORYBOOK_TYPES__;
    var pf = __STORYBOOK_API__,
      {
        ...
        experimental_getStatusStore: ga,
        experimental_getTestProviderStore: Cl,
        experimental_requestResponse: Nf,
        experimental_useStatusStore: Sl,
        experimental_useTestProviderStore: xl,
        experimental_useUniversalStore: Ff,
        internal_fullStatusStore: Mf,
    ...
    var xn = __REACT_DOM__,
      {
        ...
        unstable_renderSubtreeIntoContainer: Bl,
        version: _9,
      } = __REACT_DOM__;
    var od =
      ...
      Pl = 'Bc2PgW_p',
      sd = 'Bc2PgW_c',
      Vl = ['#FFC700', '#FF0000', '#2E3191', '#41BBC7'],
      Hl = 3500,
      jl = 0.5,
      Dl = 150,
      zl = 'mix',
    ...
    function dd(e, t = {}) {
      ...
      ((function (f) {
        ...
        let E = _r('style');
        ((E.dataset.neoconfetti = ''), (E.textContent = f), Zr(document.head, E));
      })(od),
        e.classList.add(sd),
      ...
      function w(f, E) {
        let C = g(),
          _ = y(o, C),
          F = (X, oe) => f.style.setProperty(X, oe + '');
        (F('--xlp', Or(Ea(Jl(E, 90) - 180), 0, 180, -m / 2, m / 2) + 'px'),
          F('--dc', r - Nn(1e3 * at()) + 'ms'));
        let V = at() < ud ? Yt(at() * md, 2) : 0;
        (F('--x1', V),
          F('--x2', -1 * V),
          F('--x3', V),
          F('--x4', Yt(Ea(Or(Ea(Jl(E, 90) - 180), 0, 180, -1, 1)), 4)),
          F('--y1', Yt(at() * Kl, 4)),
          F('--y2', Yt(at() * i * (eo() ? 1 : -1), 4)),
          F('--y3', Kl),
          F('--y4', Yt(pd(Or(Ea(E - 180), 0, 180, i, -i), 0), 4)),
          F('--w', (_ ? s : Nn(4 * at()) + s / 2) + 'px'),
          F('--h', (_ ? s : Nn(2 * at()) + s) + 'px'));
        let D = C.toString(2).padStart(3, '0').split('');
        (F('--hr', D.map((X) => +X / 2 + '').join(' ')),
          F('--r', D.join(' ')),
          F('--rd', Yt(at() * (cd - Yl) + Yl) + 'ms'),
          F('--br', _ ? '50%' : 0));
      }
      let b;
      function h() {
        ((e.innerHTML = ''),
          ...
          (v = (function (f, E = [], C) {
            ...
            for (let { color: F } of E) {
              let V = _r('div');
              ((V.className = `${Pl} ${C}`), V.style.setProperty('--bgc', F));
              let D = _r('div');
              (Zr(V, D), Zr(f, V), _.push(V));
            }
            return _;
          })(e, p, d)));
        for (let [f, E] of Xl(v)) w(E, p[+f].degree);
        b = setTimeout(() => {
          c && (e.innerHTML = '');
        }, r);
      }
      return (
        ...
        {
          update(f) {
            let E = f.particleCount ?? Dl,
              C = f.particleShape ?? zl,
              _ = f.particleSize ?? Ul,
              F = f.particleClass ?? $l,
              V = f.colors ?? Vl,
              D = f.stageHeight ?? Gl,
              ...
              oe = f.force ?? jl,
              ge = f.stageWidth ?? ql,
              fe = f.destroyAfterDone ?? Wl;
            p = Ql(E, V);
            let ce = !1;
            if (E === l) {
              v = Array.from(e.querySelectorAll(`.${Pl}`));
              for (let [ye, { color: we }] of Xl(p)) {
                let He = v[+ye];
                (JSON.stringify(n) !== JSON.stringify(V) && He.style.setProperty('--bgc', we),
                  C !== o && He.style.setProperty('--br', y(C, g()) ? '50%' : '0'),
                  F !== d && (d && He.classList.remove(d), F && He.classList.add(F)));
              }
            } else ce = !0;
            (c && !fe && clearTimeout(b),
    ...
    var Yl = 200,
      ...
      Zr = (e, t) => e.appendChild(t),
      Ql = (e, t) =>
        Array.from({ length: e }, (n, r) => ({ color: t[r % t.length], degree: (360 * r) / e })),
      Yt = (e, t = 2) => Nn((e + Number.EPSILON) * 10 ** t) / 10 ** t,
      Or = (e, t, n, r, i) => ((e - t) * (i - r)) / (n - t) + r,
      Jl = (e, t) => (e + t > 360 ? e + t - 360 : e + t),
      eo = () => at() > 0.5,
      Xl = Object.entries,
      hd = 6,
      fd = (e) => e !== 1 && eo();
    function to({ class: e, ...t }) {
      let n = be(null),
        r = be();
      return (
        te(() => {
    ...
    function Vr(
      ...
      if (
        (V && (h = -h),
        (b === -1 || isNaN(b)) && ((b = Math.floor(Math.log(h) / Math.log(_))), b < 0 && (b = 0)),
        b > 8 && (w > 0 && (w += 8 - b), (b = 8)),
        m === bd)
      )
        return b;
      if (h === 0) ((f[0] = 0), (C = f[1] = Pr.symbol[u][t ? no : ao][b]));
      else {
        ((E = h / (r === 2 ? Math.pow(2, b * 10) : Math.pow(1e3, b))),
          t && ((E = E * 8), E >= _ && b < 8 && ((E = E / _), b++)));
        let X = Math.pow(10, b > 0 ? i : 0);
        ((f[0] = D(E * X) / X),
          f[0] === _ && b < 8 && g === -1 && ((f[0] = 1), b++),
          (C = f[1] = r === 10 && b === 1 ? (t ? xd : 'kB') : Pr.symbol[u][t ? no : ao][b]));
      }
      if (
        (V && (f[0] = -f[0]),
        ...
        let X = f[0].toString(),
          ...
          ge = X.toString().split(oe),
          fe = ge[1] || '',
          ce = fe.length,
          ye = i - ce;
        f[0] = `${ge[0]}${oe}${fe.padEnd(ce + ye, '0')}`;
      }
      return (
        F && (f[1] = v[b] ? v[b] : Pr.fullform[u][b] + (t ? 'bit' : yd) + (f[0] === 1 ? '' : 's')),
        m === vd ? f : m === Cd ? { value: f[0], symbol: f[1], exponent: b, unit: C } : f.join(d)
      );
    }
    var Fd = Object.create,
      ...
      Zd = (e, t, n, r) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let i of Ad(t))
            !Td.call(e, i) &&
              i !== n &&
              j1(e, i, { get: () => t[i], enumerable: !(r = Md(t, i)) || r.enumerable });
        return e;
      },
      ht = (e, t, n) => (
        (n = e != null ? Fd(Ld(e)) : {}),
        Zd(t || !e || !e.__esModule ? j1(n, 'default', { value: e, enumerable: !0 }) : n, e)
      ),
      zi = At((e, t) => {
        (function (n, r) {
          typeof _d == 'function' && typeof e == 'object' && typeof t == 'object'
            ? (t.exports = r())
          ...
          function p(y, w, b) {
            return function (h) {
              var f = h.toLowerCase();
              return w.hasOwnProperty(f) ? d(h, f) : y.hasOwnProperty(f) ? d(h, y[f]) : m(f, h, b);
            };
          }
          function v(y, w, b, h) {
            return function (f) {
              var E = f.toLowerCase();
              return w.hasOwnProperty(E) ? !0 : y.hasOwnProperty(E) ? !1 : m(E, E, b) === E;
            };
          }
          function g(y, w, b) {
          ...
          return (
            ...
            (g.addIrregularRule = function (y, w) {
              ((w = w.toLowerCase()), (y = y.toLowerCase()), (o[y] = w), (l[w] = y));
            }),
            [
              ['I', 'we'],
              ['me', 'us'],
      ...
      Ui = At((e, t) => {
        ...
        function u(f, E, C) {
          return f.concat(E).map(function (_) {
            return c(_, C);
          });
        }
        function m(f, E) {
        ...
        function y(f, E) {
          return (
            g(f, E) && !(Object.hasOwnProperty.call(f, E) && Object.propertyIsEnumerable.call(f, E))
          );
        }
        function w(f, E, C) {
          var _ = {};
          return (
            C.isMergeableObject(f) &&
              v(f).forEach(function (F) {
                _[F] = c(f[F], C);
              }),
            v(E).forEach(function (F) {
              y(f, F) ||
                (g(f, F) && C.isMergeableObject(E[F])
                  ? (_[F] = m(F, C)(f[F], E[F], C))
                  : (_[F] = c(E[F], C)));
            }),
            _
        ...
        function b(f, E, C) {
          ...
          var _ = Array.isArray(E),
            F = Array.isArray(f),
            V = _ === F;
          return V ? (_ ? C.arrayMerge(f, E, C) : w(f, E, C)) : c(E, C);
        }
        b.all = function (f, E) {
          if (!Array.isArray(f)) throw new Error('first argument should be an array');
          return f.reduce(function (C, _) {
            return b(C, _, E);
          }, {});
        };
        var h = b;
      ...
      }),
      {
        ...
        CHROMATIC_BASE_URL: mr = Hd || 'https://www.chromatic.com',
        CHROMATIC_API_URL: jd = `${mr}/api`,
      } = Oe,
      U = 'chromaui/addon-visual-tests',
      rn = `${U}/panel`,
      di = `${U}/test-provider`,
      ci = `${U}/access-token/${mr}`,
      $i = `${U}/configInfo`,
      ro = `${U}/configInfoDismissed`,
      Dd = `${U}/gitInfo`,
      D1 = `${U}/gitInfoError`,
      z1 = `${U}/projectInfo`,
      U1 = `${U}/isOffline`,
      ...
      q1 = De(null),
      Xd = ({ children: e, value: t }) => a.createElement(q1.Provider, { value: t }, e),
      Wi = () => ft(q1, 'AuthState'),
      e5 = {
    ...
    function pi(e) {
      ...
      return (
        (pi = function (n) {
          ...
          function r() {
            return i5(n, arguments, mi(this).constructor);
          }
          return (
    ...
    function v5(e, t, n) {
      return hi('#' + Dr(e) + Dr(t) + Dr(n));
    }
    function Pa(e, t, n) {
      return Un(e, t, n, v5);
    }
    function y5(e, t, n) {
      if (typeof e == 'number' && typeof t == 'number' && typeof n == 'number') return Pa(e, t, n);
      if (typeof e == 'object' && t === void 0 && n === void 0)
        return Pa(e.hue, e.saturation, e.lightness);
      throw new it(1);
    }
    function b5(e, t, n, r) {
      if (
    ...
    function gi(e, t, n, r) {
      if (typeof e == 'string' && typeof t == 'number') {
        ...
        if (
          ...
          return r >= 1 ? fi(e, t, n) : 'rgba(' + e + ',' + t + ',' + n + ',' + r + ')';
        if (typeof e == 'object' && t === void 0 && n === void 0 && r === void 0)
          return e.alpha >= 1
            ? fi(e.red, e.green, e.blue)
    ...
    function S5(e, t) {
      ...
      var n = Q1(t);
      return J1(Ba({}, n, { lightness: ts(0, 1, n.lightness - parseFloat(e)) }));
    }
    var x5 = es(S5),
      It = x5;
    function N5(e, t) {
    ...
    var F5 = es(N5),
      ...
      wa = 5.55555;
    se({
      padding: `0 ${qi.padding.medium}px`,
      [`@media (min-width: ${ka * 1}px)`]: { margin: `0 ${wa * 1}%` },
      [`@media (min-width: ${ka * 2}px)`]: { margin: `0 ${wa * 2}%` },
      [`@media (min-width: ${ka * 3}px)`]: { margin: `0 ${wa * 3}%` },
      [`@media (min-width: ${ka * 4}px)`]: { margin: `0 ${wa * 4}%` },
    });
    se({
      border: `1px solid ${P.border}`,
      borderRadius: `${qi.borderRadius.small}px`,
      transition: 'background 150ms ease-out, border 150ms ease-out, transform 150ms ease-out',
      '&:hover, &.__hover': {
        borderColor: `${gi(P.secondary, 0.5)}`,
        transform: 'translate3d(0, -3px, 0)',
        boxShadow: 'rgba(0, 0, 0, 0.08) 0 3px 10px 0',
      },
      '&:active, &.__active': {
        borderColor: `${gi(P.secondary, 1)}`,
        transform: 'translate3d(0, 0, 0)',
      },
    });
    ...
    var ns = Ct({ from: { transform: 'rotate(0deg)' }, to: { transform: 'rotate(360deg)' } }),
      as = Ct({ '0%, 100%': { opacity: 1 }, '50%': { opacity: 0.4 } });
    Ct({
    ...
    var A5 = se({
      ...
      T5 = k(Gi)(
        {
          ...
          display: 'block',
          verticalAlign: 'top',
          path: { fill: P.medium, animation: `${as} 1.5s ease-in-out infinite` },
        },
        (e) => ({
      ...
      Z5 = ({
        ...
        let o = a.createElement(T5, { icon: i === 'user' ? 'useralt' : 'repository', type: i }),
          s = {};
        return (
          e
            ...
            : n
              ...
              : ((s['aria-label'] = t),
                (o = a.createElement(_5, { size: r, 'aria-hidden': 'true' }, t.substring(0, 1)))),
      ...
      I5 = k.a(
        ...
        (e) => ({
          ...(e.secondary && {
            ...
            '&:active': { color: e.theme.base === 'light' ? P.darker : P.lighter },
          }),
          ...(e.tertiary && {
            color: P.dark,
    ...
    var Ne = W(({ children: e, withArrow: t, ...n }, r) => {
      let i = a.createElement(
        a.Fragment,
        null,
        a.createElement(O5, { withArrow: !!t }, e, t && a.createElement(Gi, { icon: 'arrowright' }))
      );
      return a.createElement(I5, { as: rs, ref: r, ...n }, i);
    });
    Ne.displayName = 'Link';
    Ne.defaultProps = {
      withArrow: !1,
    ...
    var P5 = k.label((e) => ({
      ...
      D5 = k.div((e) => ({
        ...
        '> svg': {
          ...
          ...(e.error && { animation: `${M5} 700ms ease-out`, path: { fill: P.red } }),
        },
      })),
      z5 = k.div(
        (e) =>
      ...
      oo = ({ error: e, value: t, lastErrorValue: n }) => {
      ...
      is = W(
        (
          ...
          let [h, f] = Le(oo({ error: r, value: y, lastErrorValue: d })),
            E = `${e}-error`;
          te(() => {
            f(oo({ error: r, value: y, lastErrorValue: d }));
          }, [y, r, d]);
    ...
    is.displayName = 'PureInput';
    var ls = W(({ type: e, startFocused: t, ...n }, r) => {
      let [i, l] = Le(e),
        o = K(
          (u) => {
      ...
      return (
        ...
        a.createElement(is, { ref: d, startingType: e, type: i, onActionClick: o, ...n })
      );
    });
    ...
    var G5 = k.div(
        {
          ...
          height: 32,
          width: 32,
          animation: `${ns} 0.7s linear infinite`,
          borderWidth: 2,
          borderStyle: 'solid',
      ...
      Yi = ({ active: e, activeColor: t, disabled: n, isLoading: r, theme: i }) => ({
        ...
        ...(r && { '.sbds-list-item-title': { ...A5, flex: '0 1 auto', display: 'inline-block' } }),
        ...(n && {
          cursor: 'not-allowed !important',
          '.sbds-list-item-title, .sbds-list-item-center': { color: i.color.mediumdark },
        }),
      }),
      ec = k(({ active: e, activeColor: t, isLoading: n, ...r }) => a.createElement('a', { ...r }))(
        Yi
      ),
      tc = k.span(Yi),
      nc = q5((e) =>
        k(({ active: t, isLoading: n, activeColor: r, ...i }) => a.createElement(e, { ...i }))(Yi)
      ),
      Ye = ({
        ...
        let c = Cn().color[e],
          u = a.createElement(
            ...
            r && a.createElement(Q5, { className: 'sbds-list-item-center' }, r),
            i && a.createElement(J5, { className: 'sbds-list-item-right' }, i)
          );
        if (o) {
          let m = nc(o);
          return a.createElement(so, null, a.createElement(m, { activeColor: c, ...d }, u));
        }
        return a.createElement(so, null, a.createElement(s ? ec : tc, { activeColor: c, ...d }, u));
      };
    function Bn(e) {
      function t(_, F) {
        return (_ >>> F) | (_ << (32 - F));
              ...
              (g[n] =
                n < 16
                  ...
                  : (g[n - 16] +
                    ...
                    0);
          (c = [
            (E + ((t(h, 2) ^ t(h, 13) ^ t(h, 22)) + ((h & c[1]) ^ (h & c[2]) ^ (c[1] & c[2])))) | 0,
          ].concat(c))[4] = (c[4] + E) | 0;
        }
    ...
    var ac = (e) => new Uint8Array(e).reduce((t, n) => t + String.fromCharCode(n), ''),
      rc = (e) => window.btoa(Array.isArray(e) ? ac(e) : e),
      co = (e) => rc(e).replace(/\+/g, '-').replace(/\//g, '_').replace(/=/g, ''),
      ...
      dc = async (e) => {
        let t = co(lc()),
          ...
          r = await fetch(`${mr}/authorize`, {
            ...
            body: os({ client_id: 'chromaui:addon-visual-tests', code_challenge: n }),
          }),
          {
            device_code: i,
            user_code: l,
      ...
      pr = De(null),
      uc = ({ children: e, value: t }) => a.createElement(pr.Provider, { value: t }, e),
      Ve = (e, t) => {
        let n = ft(pr, 'Telemetry');
      ...
      hr = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
        S(
          'svg',
          {
            width: t,
      ...
      Ki = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
        S(
          'svg',
          {
            width: t,
      ...
      uo = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
        S(
          'svg',
          {
            width: t,
      ...
      return K(
        (l, o) => {
          t({
            ...
            icon: a.createElement(ln, { color: wn.negative }),
            onClick: i,
          });
        },
        [t, i]
        ...
        l = gt(
          () =>
            yi(
              e,
              (s) => {
                let d = new Set(sessionStorage.getItem(`${U}/state`)?.split(';'));
                (s == null
                  ? (sessionStorage.removeItem(`${U}/state/${e}`), d.delete(e))
                  : (sessionStorage.setItem(`${U}/state/${e}`, JSON.stringify(s)), d.add(e)),
    ...
    var hs = De(void 0),
      ...
      gs = (e) =>
        a.createElement(
          ...
          a.createElement('circle', { fill: '#FC521F', cx: '125', cy: '125', r: '125' }),
          a.createElement(
            'g',
      ...
      vs = k.div({ display: 'flex', flexDirection: 'column' }),
      bi = k.div(({ theme: e }) => ({
        padding: 15,
        lineHeight: '18px',
      ...
      Va = k.div({ display: 'flex', fontWeight: 'bold', marginBottom: 15 }),
      mo = k(Sc)(({ theme: e }) => ({
        width: 12,
        height: 12,
        margin: '3px 6px',
      ...
      fr = { width: 14, height: 14, margin: '2px 6px 2px 0', verticalAlign: 'top' },
      Hc = k(Oc)(fr),
      jc = k(fc)(fr),
      Dc = k(ss)(fr),
      zc = k(gc)(fr),
      Xi = k(Qi)({ marginLeft: 'auto' }),
      el = k(ct)({ margin: -5, marginLeft: 'auto' }),
      re = k(Sn)(
        {
          '&&': {
            display: 'inline-flex',
      ...
      po = 'experimental_useSharedState_getValue',
      Ca = 'experimental_useSharedState_setValue',
      zr = new Map(),
      ys = class {
        constructor(e) {
          ((this.channel = e),
            (this.listeners = []),
            (this.state = {}),
            this.channel.on(Ca, (t, n, r) => {
              this.state?.[t]?.index >= r || (this.state[t] = { index: r, value: n });
            }),
            this.channel.on(po, (t) => {
              let n = this.state[t]?.index ?? 0,
                r = this.state[t]?.value;
              this.channel.emit(Ca, t, r, n);
            }));
        }
        get(e) {
          return (this.state[e] || this.channel.emit(po, e), this.state[e]?.value);
        }
        set(e, t) {
          let n = (this.state[e]?.index ?? 0) + 1;
          ((this.state[e] = { index: n, value: t }), this.channel.emit(Ca, e, t, n));
        }
        static subscribe(e, t) {
          let n = zr.get(e) || new ys(t);
          return (
            zr.has(e) ||
              (zr.set(e, n),
              n.channel.on(Ca, (r, i) => {
    ...
    var Uc = {
      ...
      $c = k(el)({ position: 'absolute', right: 16, top: 10 }),
      Wc = k.div(({ theme: e }) => ({
      ...
      go = k.div({ display: 'flex', flexGrow: 1, flexWrap: 'wrap', gap: '5px 10px' }),
      vo = k.div(({ theme: e }) => ({
        fontWeight: e.typography.weight.bold,
        div: { marginLeft: 5, position: 'relative', top: 2 },
      })),
      yo = k.div({ marginTop: 10 }),
      ...
      Qc = k.div(({ theme: e }) => ({ color: e.color.warningText })),
      bo = k.div(({ theme: e }) => ({
        color: e.base === 'dark' ? e.color.medium : e.color.dark,
        marginTop: 2,
      })),
      Eo = k.div(({ warning: e, theme: t }) => ({
        alignItems: 'center',
        display: 'flex',
        backgroundColor: e
          ? t.base === 'dark'
      ...
      bs = { height: 12, margin: 2, verticalAlign: 'top', width: 12 },
      Xc = k(Nc)(bs),
      eu = k(bc)(bs),
      tu = ({ onClose: e }) => {
        let { uninstallAddon: t } = fs(),
          [n] = ke($i),
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(Xi, { 'aria-label': 'Close' })
          ),
          a.createElement(
            Gc,
            null,
              ...
              a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      ...
                      a.createElement(
                        go,
                        null,
                        a.createElement(vo, null, c, ' '),
                        c in Jd && a.createElement(Qc, null, '*Disabled for local builds')
                      ),
                      a.createElement(bo, null, Uc[c]?.description),
                      a.createElement(
                        yo,
                        null,
                        a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement(
                    fo,
                    null,
                    a.createElement(go, null, a.createElement(vo, null, 'Uninstall addon')),
                    a.createElement(
                      bo,
                      null,
                      'Removing the addon updates your Storybook configuration and uninstalls the dependency.'
                    ),
                    a.createElement(yo, null, a.createElement(re, { onClick: t }, 'Uninstall'))
                  )
                )
              )
          )
      ...
      ru = ({ children: e, initialState: t = Es }) => {
        let [n, r] = wl(au, t);
        return a.createElement(
          ks.Provider,
          { value: n },
          a.createElement(ws.Provider, { value: r }, e)
        );
      },
      Ie = k(ya)({ marginBottom: '-4px', marginTop: '-4px', left: -8 }),
    ...
    var $n = ({ children: e, links: t, note: n, ...r }) => {
        let [i, l] = a.useState(!1),
          o = a.createElement(
            Ee,
            {
              ...
              tooltip: ({ onHide: s }) =>
                a.createElement(iu, null, a.createElement(Ol, { links: t.map(Cs(s)) })),
              trigger: 'click',
              ...r,
            },
        ...
        return n
          ? a.createElement(
              Ee,
              { tooltip: a.createElement(Ie, { note: n }), trigger: 'hover', hasChrome: !1 },
              o
            )
          : o;
      },
      vr = () => {
        let { accessToken: e, setAccessToken: t, subdomain: n } = Wi(),
          { toggleConfig: r } = vn(),
          [i] = ke(z1),
          l = ga(U),
          { projectId: o } = i || {},
        ...
        return a.createElement($n, { placement: 'top', links: s }, a.createElement(yc, null));
      };
    ...
    var lu = k.div(
      ...
      Vn = k.div(({ grow: e }) => e && { flexGrow: e ? 1 : 'auto' }),
      Pn = k.div(
      ...
      ou = k(Pn)({ alignItems: 'center', height: 40, margin: '0 10px' }),
      We = k.div(
      ...
      cu = ({ hidden: e, ignoreConfig: t, ignoreSuggestions: n, onOpen: r }) => {
        let [i] = ke($i),
          l = Object.keys(i?.problems || {}),
          o = Object.keys(i?.suggestions || {}),
          [s, d] = Le(() => !!localStorage.getItem(ro)),
          c = K(() => {
            (d(!0), localStorage.setItem(ro, 'true'));
          }, []),
          u = a.createElement(
            Ne,
            ...
            ? a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement(
                    We,
                    { push: !0 },
                    a.createElement(ct, { onClick: c }, a.createElement(Qi, null))
                  )
                )
              )
            : null;
      ...
      wo = k.div(({ hidden: e, interstitial: t, theme: n }) => ({
      ...
      pe = ({
        ...
        footer: t = a.createElement(
          ...
          a.createElement(We, null, a.createElement(vr, null))
        ),
        ignoreConfig: n = !1,
        ignoreSuggestions: r = !t,
        interstitial: i = !1,
      }) => {
        let { configVisible: l } = gr(),
          { toggleConfig: o } = vn(),
          s = K(
            (d) => {
              (o(!0),
        ...
        return a.createElement(
          uu,
          null,
          a.createElement(cu, { onOpen: s, hidden: l, ignoreConfig: n, ignoreSuggestions: r }),
          a.createElement(wo, { hidden: l, interstitial: i }, e),
          a.createElement(wo, { hidden: !l }, a.createElement(tu, { onClose: () => o(!1) })),
          t
        );
      },
      ne = k.div((e) => ({
        ...
        a.createElement(
          ...
          e &&
            a.createElement(
              We,
              null,
              a.createElement(Co, { onClick: e }, a.createElement(Mc, null), 'Back')
            ),
          a.createElement(
            We,
            { push: !0 },
            a.createElement(
              Ee,
              {
                ...
                hasChrome: !1,
                trigger: 'hover',
                tooltip: a.createElement(Ie, { note: 'Learn about visual tests' }),
              },
              a.createElement(
                Co,
                { asChild: !0 },
                a.createElement(
                  'a',
                  { href: 'https://www.chromatic.com/storybook', target: '_blank' },
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                ...
                a.createElement(re, { link: !0, onClick: () => n() }, 'Sign in with SSO')
              )
            )
          )
        ),
      ...
      q;
    function ve(e) {
      return new Ei(`Syntax Error: Unexpected token at ${q} in ${e}`);
    }
    function Re(e) {
...
`),
        ...
        ((Sa.lastIndex = 0),
          Sa.test(t[o]) &&
            (o && (!r || Sa.lastIndex < r) && (r = Sa.lastIndex), (i = i || o), (l = o)));
      for (var s = i; s <= l; s++)
        (s !== i &&
          (n += `
`),
    ...
    function mt() {
      var e;
      if ((e = Re(Ss))) return { kind: 'Name', value: e };
    }
    ...
    function Ha(e) {
      ...
      } else if ((n = Re(Ss))) t = { kind: 'EnumValue', value: n };
      else if ((n = Re(Au))) t = { kind: 'StringValue', value: Su(n.slice(3, -3)), block: !0 };
      else if ((n = Re(Lu)))
        t = { kind: 'StringValue', value: Mu.test(n) ? JSON.parse(n) : n.slice(1, -1), block: !1 };
      else if (
        (t =
          (function (i) {
            var l;
            if (ue.charCodeAt(q) === 91) {
              (q++, J());
              for (var o = []; (l = Ha(i)); ) o.push(l);
              if (ue.charCodeAt(q++) !== 93) throw ve('ListValue');
          ...
          (function (i) {
            if (ue.charCodeAt(q) === 123) {
              (q++, J());
              for (var l = [], o; (o = mt()); ) {
                if ((J(), ue.charCodeAt(q++) !== 58)) throw ve('ObjectField');
                J();
                var s = Ha(i);
                if (!s) throw ve('ObjectField');
                l.push({ kind: 'ObjectField', name: o, value: s });
              }
              if (ue.charCodeAt(q++) !== 125) throw ve('ObjectValue');
    ...
    function Ns(e) {
      var t = [];
      if ((J(), ue.charCodeAt(q) === 40)) {
        (q++, J());
        for (var n; (n = mt()); ) {
          if ((J(), ue.charCodeAt(q++) !== 58)) throw ve('Argument');
          J();
          var r = Ha(e);
          if (!r) throw ve('Argument');
          t.push({ kind: 'Argument', name: n, value: r });
        }
        if (!t.length || ue.charCodeAt(q++) !== 41) throw ve('Argument');
        J();
      }
      return t;
    }
    function on(e) {
      var t = [];
      for (J(); ue.charCodeAt(q) === 64; ) {
        q++;
        var n = mt();
        if (!n) throw ve('Directive');
        (J(), t.push({ kind: 'Directive', name: n, arguments: Ns(e) }));
      }
      return t;
    }
    function Tu() {
      ...
      if (e) {
        ...
        if (ue.charCodeAt(q) === 58) {
          if ((q++, J(), (t = e), !(e = mt()))) throw ve('Field');
          J();
        }
        return {
          kind: 'Field',
    ...
    function Fs() {
      var e;
      if ((J(), ue.charCodeAt(q) === 91)) {
        (q++, J());
        var t = Fs();
        if (!t || ue.charCodeAt(q++) !== 93) throw ve('ListType');
        e = { kind: 'ListType', type: t };
      } else if ((e = mt())) e = { kind: 'NamedType', name: e };
      else throw ve('NamedType');
      return (J(), ue.charCodeAt(q) === 33 ? (q++, J(), { kind: 'NonNullType', type: e }) : e);
    }
    var _u = /on/y;
    function Ms() {
      if (Re(_u)) {
    ...
    function Ou() {
      if (Re(Zu)) {
        ...
        var n = Ms(),
          r = on(!1),
          i = br();
        if (!i) throw ve('InlineFragment');
        return { kind: 'InlineFragment', typeCondition: n, directives: r, selectionSet: i };
      }
    }
    function br() {
      var e;
      if ((J(), ue.charCodeAt(q) === 123)) {
        (q++, J());
        for (var t = []; (e = Ou() || Tu()); ) t.push(e);
        if (!t.length || ue.charCodeAt(q++) !== 125) throw ve('SelectionSet');
    ...
    function Ru() {
      if (Re(Iu)) {
        J();
        var e = mt();
        if (!e) throw ve('FragmentDefinition');
        J();
        var t = Ms();
        if (!t) throw ve('FragmentDefinition');
        var n = on(!1),
          r = br();
        if (!r) throw ve('FragmentDefinition');
        return {
    ...
    function Pu() {
      ...
      (e = Re(Bu)) &&
        ...
        (n = (function () {
          ...
          if ((J(), ue.charCodeAt(q) === 40)) {
            for (q++, J(); (l = Re(xs)); ) {
              if ((J(), ue.charCodeAt(q++) !== 58)) throw ve('VariableDefinition');
              var s = Fs(),
                d = void 0;
              if (ue.charCodeAt(q) === 61 && (q++, J(), !(d = Ha(!0))))
                throw ve('VariableDefinition');
              (J(),
                o.push({
            ...
            if (ue.charCodeAt(q++) !== 41) throw ve('VariableDefinition');
            J();
          }
          return o;
        })()),
    ...
    var ze = (e) => !(!e || !e.length),
      Se = {
        OperationDefinition(e) {
          if (e.operation === 'query' && !e.name && !ze(e.variableDefinitions) && !ze(e.directives))
          ...
          return (
            ...
            ze(e.directives) && (t += ' ' + e.directives.map(Se.Directive).join(' ')),
            t + ' ' + Se.SelectionSet(e.selectionSet)
          );
        },
        VariableDefinition(e) {
          var t = Se.Variable(e.variable) + ': ' + Ue(e.type);
          return (
            e.defaultValue && (t += ' = ' + Ue(e.defaultValue)),
            ze(e.directives) && (t += ' ' + e.directives.map(Se.Directive).join(' ')),
            t
          );
        },
...
`
  ...
  `
        ...
        FragmentSpread(e) {
          var t = '...' + e.name.value;
          return (ze(e.directives) && (t += ' ' + e.directives.map(Se.Directive).join(' ')), t);
        },
        InlineFragment(e) {
          var t = '...';
          return (
        ...
        Directive(e) {
          var t = '@' + e.name.value;
          return (ze(e.arguments) && (t += '(' + e.arguments.map(Se.Argument).join(', ') + ')'), t);
        },
                ...
                : ((l = !1),
                  (function (d) {
                    ...
                    d((u) => {
                      ...
                      } else u.tag === 0 ? (r.push((c = u[0])), c(0)) : r.length && (n(u), c(0));
                    });
                  })(e(s[0])),
                  l || ((l = !0), i(0))));
        }),
    ...
    function Ci() {
      var e, t;
      return {
        source: Gn(_s((n) => ((e = n.next), (t = n.complete), nl))),
        next(n) {
          e && e(n);
        },
        complete() {
    ...
    var qu = (e) =>
        e && e.message && (e.extensions || e.name === 'GraphQLError')
          ...
          : typeof e == 'object' && e.message
            ? new Ei(e.message, e.nodes, e.source, e.positions, e.path, e, e.extensions || {})
            : new Ei(e),
...
`),
      ...
      Jt = (e) => {
        ...
        if (e.toJSON) return Jt(e.toJSON());
        if (Array.isArray(e)) {
          var t = '[';
          for (var n of e) (t.length > 1 && (t += ','), (t += Jt(n) || 'null'));
          return (t += ']');
        } else if ((Ua !== dn && e instanceof Ua) || ($a !== dn && e instanceof $a)) return 'null';
        ...
        if (
          ...
          return (Fo.set(e, i), Jt({ __key: i }));
        }
        Pt.add(e);
        var l = '{';
        for (var o of r) {
          var s = Jt(e[o]);
          s && (l.length > 1 && (l += ','), (l += Jt(o) + ':' + s));
        }
        return (Pt.delete(e), (l += '}'));
      },
      xi = (e, t, n) => {
        if (!(n == null || typeof n != 'object' || n.toJSON || Pt.has(n)))
          if (Array.isArray(n)) for (var r = 0, i = n.length; r < i; r++) xi(e, `${t}.${r}`, n[r]);
          else if (n instanceof Ua || n instanceof $a) e.set(t, n);
          else {
            Pt.add(n);
            for (var l of Object.keys(n)) xi(e, `${t}.${l}`, n[l]);
          }
      },
      za = (e) => (Pt.clear(), Jt(e)),
      dn = class {},
      Ua = typeof File < 'u' ? File : dn,
      $a = typeof Blob < 'u' ? Blob : dn,
      Yu = /("{3}[\s\S]*"{3}|"(?:\\.|[^"])*")/g,
      Ku = /(?:#[^\n\r]+)?(?:[\r\n]+|$)/g,
      Qu = (e, t) =>
        t % 2 == 0
...
`
          ...
          : e,
      Mo = (e) => e.split(Yu).map(Qu).join('').trim(),
      Ao = new Map(),
      Ia = new Map(),
      ll = (e) => {
        var t;
        return (
          typeof e == 'string'
            ? (t = Mo(e))
            : e.loc && Ia.get(e.__key) === e
              ? (t = e.loc.source.body)
              : ((t = Ao.get(e) || Mo(Ue(e))), Ao.set(e, t)),
          typeof e != 'string' &&
            !e.loc &&
            (e.loc = {
              start: 0,
...
# ${n}`,
      ...
      Ju = (e) => {
        ...
        return (
          typeof e == 'string'
            ? ((t = Lo(e)), (n = Ia.get(t) || Vu(e)))
            : ((t = e.__key || Lo(e)), (n = Ia.get(t) || e)),
          n.loc || ll(n),
          (n.__key = t),
          Ia.set(t, n),
          n
      ...
      nn = (e, t, n) => {
        var r = t || {},
          ...
          l = za(r),
          o = i.__key;
        return (l !== '{}' && (o = Si(l, o)), { key: o, query: i, variables: r, extensions: n });
      },
      Zs = (e) => {
      ...
      To = (e, t, n) => {
        ...
        return {
          ...
          error: Array.isArray(t.errors)
            ? new il({ graphQLErrors: t.errors, response: n })
            : void 0,
      ...
      Ni = (e, t) => {
        if (
          ...
          for (var n of Object.keys(t)) e[n] = Ni(e[n], t[n]);
          return e;
        }
        return t;
      },
      Xu = (e, t, n, r) => {
        ...
        if (s) {
          var c = function (m) {
            ...
            if (m.items)
              for (var h = +p >= 0 ? p : 0, f = 0, E = m.items.length; f < E; f++)
                v[h + f] = Ni(v[h + f], m.items[f]);
            else m.data !== void 0 && (v[p] = Ni(v[p], m.data));
          };
          for (var u of s) c(u);
        ...
        return {
          ...
          data: d.data,
          error: i.length ? new il({ graphQLErrors: i, response: n }) : void 0,
      ...
      Os = (e, t, n) => ({
        operation: e,
        data: void 0,
        error: new il({ networkError: t, response: n }),
        extensions: void 0,
        hasNext: !1,
        stale: !1,
      });
    ...
    var t2 = (e, t) => {
        ...
        for (var i in t) {
          var l = t[i];
          l && r.searchParams.set(i, typeof l == 'object' ? za(l) : l);
        }
        var o = r.toString();
      ...
      n2 = (e, t) => {
        if (t && !(e.kind === 'query' && e.context.preferGetMethod)) {
          var n = za(t),
            r = ((s) => {
              var d = new Map();
              return ((Ua !== dn || $a !== dn) && (Pt.clear(), xi(d, 'variables', s)), d);
            })(t.variables);
          if (r.size) {
            var i = new FormData();
            (i.append('operations', n), i.append('map', za({ ...[...r.keys()].map((s) => [s]) })));
            var l = 0;
...
`
        ...
        for await (var c of s)
          (c.pending && !i ? (d = c.pending) : c.pending && (d = [...d, ...c.pending]),
            (i = i ? Xu(i, c, l, d) : To(e, c, l)),
            (r = !1),
            yield i,
            (r = !0));
        i || (yield (i = To(e, {}, l)));
    ...
    function Io(e) {
      var t = (n) => e(n);
      return (
        (t.toPromise = () => rl(Er(1)(_e((n) => !n.stale && !n.hasNext)(t)))),
    ...
    var d2 = () => {},
        ...
        (n) => {
          var r = ja((l) => {
              var o = e2(l),
                s = t2(l, o),
                d = a2(l, o),
                c = As(_e((u) => u.kind === 'teardown' && u.key === l.key)(n))(s2(l, s, d));
              return c;
            })(
              _e(
                (l) =>
      ...
      h2 = function e(t) {
        ...
        var p = (h) => {
            var f = As(_e((E) => E.kind === 'teardown' && E.key === h.key)(d.source))(
              _e(
                (E) =>
            ...
            return (
              t.maskTypename && (f = ki((E) => ({ ...E, data: Fi(E.data, !0) }))(f)),
              h.kind !== 'query'
                ? (f = Ls((E) => !!E.hasNext, !0)(f))
                : (f = xo((E) => {
                    var C = Hn(E);
                    return E.stale || E.hasNext
                      ...
                      : Wn([
                          C,
                          ki(() => ((E.stale = !0), E))(
                            Er(1)(_e((_) => _.key === h.key)(d.source))
                          ),
                        ]);
                  })(f)),
              h.kind !== 'mutation'
          ...
          g = Object.assign(v, {
            ...
            reexecuteOperation(h) {
              if (h.kind === 'teardown') m(h);
                ...
                for (var f = !1, E = 0; E < o.length; E++) f = f || o[E].key === h.key;
                ...
                : Io(
                    Uu(() => {
                      ...
                      return h.kind === 'query' && E && (E.stale || E.hasNext)
                        ? xo(Hn)(Wn([f, _e((C) => C === r.get(h.key))(Hn(E))]))
                        : f;
                    })
                  );
            },
    ...
    function sl(e) {
      var t = ol(),
        ...
        [d, c] = Le(() => [l, Ur(Mi, o(l, r)), s]),
        u = d[1];
      (l !== d[0] && y2(d[2], s) && c([l, (u = Ur(d[1], o(l, r))), s]),
        te(() => {
          var p = d[0],
            v = d[2][1],
            g = !1,
    ...
    var $r = (e, t) => Wa(e.kind, e, { ...e.context, authAttempt: t });
    function O2(e) {
      return ({ client: t, forward: n }) => {
        ...
        return (m) => {
          ...
          p();
          function v(b) {
            (o.set(b.key, $r(b, !0)), u && !c && (c = u.refreshAuth().then(s).catch(d)));
          }
          function g(b) {
                ...
                b.kind === 'teardown'
                  ...
                  : b.context._instance && r.has(b.context._instance)
                    ...
                    : b.context.authAttempt
                      ? g(b)
                      : c || !u
                        ? (c || p(), o.has(b.key) || o.set(b.key, $r(b, !1)), null)
                        : (function (h) {
                              return (
    ...
    var H2 = V2,
      ...
      qa = (e) => {
        ...
        lt ? localStorage.setItem(ci, lt) : localStorage.removeItem(ci);
      };
    qa(localStorage.getItem(ci));
    var Rs = () => {
        let [{ token: e }, t] = Nl(`${U}/accessToken`, { token: lt }),
          n = a.useCallback(
            (r) => {
              (qa(r), t({ token: lt }));
            },
      ...
      Ps = (e) =>
        new h2({
          ...
          exchanges: [
            m2({
              onResult(t) {
                t.data?.viewer === null && qa(null);
              },
            }),
            O2(async (t) => ({
              addAuthToOperation(n) {
                return lt ? t.appendHeaders(n, { Authorization: `Bearer ${lt}` }) : n;
              },
              didAuthError: (n) =>
              ...
              willAuthError() {
                ...
                try {
                  if (!jn) {
                    let { exp: n } = JSON.parse(atob(lt.split('.')[1]));
                    jn = n;
                  }
      ...
      D2 = ({ children: e, value: t = Ps() }) => a.createElement(g2, { value: t }, e),
      ae;
    (function (e) {
      e.assertEqual = (i) => i;
      function t(i) {}
    ...
    function T(e, t) {
      let n = Ka({
        ...
        data: e.data,
        path: e.path,
        errorMaps: [e.common.contextualErrorMap, e.schemaErrorMap, Ya(), qn].filter((r) => !!r),
      });
    ...
    var Me = class {
      ...
      Hs = (e) => ({ status: 'dirty', value: e }),
      Ae = (e) => ({ status: 'valid', value: e }),
      Li = (e) => e.status === 'aborted',
      Ti = (e) => e.status === 'dirty',
      Yn = (e) => e.status === 'valid',
    ...
    var Y = class {
        ...
        brand() {
          return new Ds({ typeName: H.ZodBranded, type: this, ...$(this._def) });
        }
        catch(e) {
          let t = typeof e == 'function' ? e : () => e;
          return new nr({ ...$(this._def), innerType: this, catchValue: t, typeName: H.ZodCatch });
        }
        describe(e) {
      ...
      Q2 = '^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$',
      Gr,
      J2 =
    ...
    function tm(e, t) {
      return !!(((t === 'v4' || !t) && J2.test(e)) || ((t === 'v6' || !t) && X2.test(e)));
    }
    var ot = class extends Y {
      ...
      trim() {
        return new ot({ ...this._def, checks: [...this._def.checks, { kind: 'trim' }] });
      }
      toLowerCase() {
        return new ot({ ...this._def, checks: [...this._def.checks, { kind: 'toLowerCase' }] });
      }
      toUpperCase() {
        return new ot({ ...this._def, checks: [...this._def.checks, { kind: 'toUpperCase' }] });
      }
      get isDatetime() {
    ...
    var Ht = class extends Y {
      ...
      get isInt() {
        return !!this._def.checks.find(
          (e) => e.kind === 'int' || (e.kind === 'multipleOf' && ae.isInteger(e.value))
        );
      }
      get isFinite() {
        let e = null,
    ...
    Kn.create = (e) => new Kn({ typeName: H.ZodBoolean, coerce: e?.coerce || !1, ...$(e) });
    ...
    cn.create = (e) =>
      new cn({ checks: [], coerce: e?.coerce || !1, typeName: H.ZodDate, ...$(e) });
    ...
    Ja.create = (e) => new Ja({ typeName: H.ZodSymbol, ...$(e) });
    ...
    Jn.create = (e) => new Jn({ typeName: H.ZodNull, ...$(e) });
    ...
    kt.create = (e) => new kt({ typeName: H.ZodNever, ...$(e) });
    ...
    Xa.create = (e) => new Xa({ typeName: H.ZodVoid, ...$(e) });
    var ut = class extends Y {
      _parse(e) {
        ...
        if (
          ...
          return Promise.all(
            [...t.data].map((l, o) => r.type._parseAsync(new pt(t, l, t.path, o)))
          ).then((l) => Me.mergeArray(n, l));
        let i = [...t.data].map((l, o) => r.type._parseSync(new pt(t, l, t.path, o)));
      ...
      min(e, t) {
        return new ut({ ...this._def, minLength: { value: e, message: R.toString(t) } });
      }
      max(e, t) {
        return new ut({ ...this._def, maxLength: { value: e, message: R.toString(t) } });
      }
      length(e, t) {
        return new ut({ ...this._def, exactLength: { value: e, message: R.toString(t) } });
      }
      nonempty(e) {
        return this.min(1, e);
      }
    ...
    function Xt(e) {
      if (e instanceof he) {
        ...
        return e instanceof ut
          ? new ut({ ...e._def, type: Xt(e.element) })
          : e instanceof bt
            ? bt.create(Xt(e.unwrap()))
            : e instanceof zt
              ? zt.create(Xt(e.unwrap()))
              : e instanceof wt
                ? wt.create(e.items.map((t) => Xt(t)))
                : e;
    }
    var he = class extends Y {
      ...
      _parse(e) {
        ...
        for (let s of i) {
          ...
          o.push({
            ...
            value: d._parse(new pt(n, c, n.path, s)),
        ...
        if (this._def.catchall instanceof kt) {
          ...
          for (let d of l) {
            ...
            o.push({
              key: { status: 'valid', value: d },
              value: s._parse(new pt(n, c, n.path, d)),
        ...
        return n.common.async
          ? Promise.resolve()
              .then(async () => {
                ...
                for (let d of o) {
                  let c = await d.key;
                  s.push({ key: c, value: await d.value, alwaysSet: d.alwaysSet });
                }
                return s;
              })
              ...
              ? {
                  errorMap: (t, n) => {
                    ...
                    return t.code === 'unrecognized_keys'
                      ? { message: (o = R.errToObj(e).message) !== null && o !== void 0 ? o : s }
                      : { message: s };
                  },
                }
              : {}),
      ...
      extend(e) {
        return new he({ ...this._def, shape: () => ({ ...this._def.shape(), ...e }) });
      }
      merge(e) {
        return new he({
    ...
    Xn.create = (e, t) => new Xn({ options: e, typeName: H.ZodUnion, ...$(t) });
    var Ra = (e) =>
        e instanceof ta
          ? Ra(e.schema)
          : e instanceof Je
    ...
    var ea = class extends Y {
      _parse(e) {
        let { status: t, ctx: n } = this._processInputParams(e),
          r = (i, l) => {
            if (Li(i) || Li(l)) return z;
            let o = _i(i.value, l.value);
            return o.valid
              ? ((Ti(i) || Ti(l)) && t.dirty(), { status: t.value, value: o.data })
    ...
    ea.create = (e, t, n) => new ea({ left: e, right: t, typeName: H.ZodIntersection, ...$(n) });
    var wt = class extends Y {
      _parse(e) {
        ...
        let r = [...n.data]
          .map((i, l) => {
            ...
            return o ? o._parse(new pt(n, i, n.path, l)) : null;
          })
          .filter((i) => !!i);
        return n.common.async
      ...
      rest(e) {
        return new wt({ ...this._def, rest: e });
      }
    };
    wt.create = (e, t) => {
      if (!Array.isArray(e))
        throw new Error('You must pass an array of schemas to z.tuple([ ... ])');
      return new wt({ items: e, typeName: H.ZodTuple, rest: null, ...$(t) });
    };
    var er = class extends Y {
        ...
        _parse(e) {
          ...
          for (let o in n.data)
            r.push({
              key: i._parse(new pt(n, o, n.path, o)),
              value: l._parse(new pt(n, n.data[o], n.path, o)),
            });
          return n.common.async ? Me.mergeObjectAsync(t, r) : Me.mergeObjectSync(t, r);
        }
        get element() {
          return this._def.valueType;
        }
        static create(e, t, n) {
          return t instanceof Y
            ? new er({ keyType: e, valueType: t, typeName: H.ZodRecord, ...$(n) })
            : new er({ keyType: ot.create(), valueType: e, typeName: H.ZodRecord, ...$(t) });
        }
      },
      tr = class extends Y {
        get keySchema() {
        ...
        _parse(e) {
          ...
          let r = this._def.keyType,
            ...
            l = [...n.data.entries()].map(([o, s], d) => ({
              key: r._parse(new pt(n, o, n.path, [d, 'key'])),
              value: i._parse(new pt(n, s, n.path, [d, 'value'])),
            }));
          if (n.common.async) {
            let o = new Map();
    ...
    tr.create = (e, t, n) => new tr({ valueType: t, keyType: e, typeName: H.ZodMap, ...$(n) });
    var mn = class extends Y {
      _parse(e) {
        ...
        let o = [...n.data.values()].map((s, d) => i._parse(new pt(n, s, n.path, d)));
        return n.common.async ? Promise.all(o).then((s) => l(s)) : l(o);
      }
      min(e, t) {
        return new mn({ ...this._def, minSize: { value: e, message: R.toString(t) } });
      }
      max(e, t) {
        return new mn({ ...this._def, maxSize: { value: e, message: R.toString(t) } });
      }
      size(e, t) {
    ...
    mn.create = (e, t) =>
      new mn({ valueType: e, minSize: null, maxSize: null, typeName: H.ZodSet, ...$(t) });
    var Dn = class extends Y {
        ...
        _parse(e) {
          ...
          if (t.parsedType !== M.function)
            return (
              T(t, { code: x.invalid_type, expected: M.function, received: t.parsedType }),
              z
            );
          function n(o, s) {
            return Ka({
              data: o,
              path: t.path,
              errorMaps: [t.common.contextualErrorMap, t.schemaErrorMap, Ya(), qn].filter(
                (d) => !!d
              ),
          ...
          if (this._def.returns instanceof pn) {
            ...
            return Ae(function (...s) {
              ...
              if (!u.success) throw new Qe([r(c, u.error)]);
              return u.data;
            });
          }
        }
        ...
        args(...e) {
          return new Dn({ ...this._def, args: wt.create(e).rest(Vt.create()) });
        }
        returns(e) {
          return new Dn({ ...this._def, returns: e });
        }
        implement(e) {
          return this.parse(e);
        }
        ...
        static create(e, t, n) {
          return new Dn({
            args: e || wt.create([]).rest(Vt.create()),
            returns: t || Vt.create(),
    ...
    ta.create = (e, t) => new ta({ getter: e, typeName: H.ZodLazy, ...$(t) });
    var na = class extends Y {
      _parse(e) {
        if (e.data !== this._def.value) {
          let t = this._getOrReturnCtx(e);
          return (
            T(t, { received: t.data, code: x.invalid_literal, expected: this._def.value }),
            z
          );
        }
    ...
    na.create = (e, t) => new na({ value: e, typeName: H.ZodLiteral, ...$(t) });
    function js(e, t) {
      ...
      _parse(e) {
        if (typeof e.data != 'string') {
          let t = this._getOrReturnCtx(e),
            n = this._def.values;
          return (
            T(t, { expected: ae.joinValues(n), received: t.parsedType, code: x.invalid_type }),
            z
          );
        }
    ...
    var aa = class extends Y {
      _parse(e) {
        ...
        if (n.parsedType !== M.string && n.parsedType !== M.number) {
          ...
          return (
            T(n, { expected: ae.joinValues(r), received: n.parsedType, code: x.invalid_type }),
            z
          );
        }
    ...
    aa.create = (e, t) => new aa({ values: e, typeName: H.ZodNativeEnum, ...$(t) });
    ...
    Je.create = (e, t, n) => new Je({ schema: e, typeName: H.ZodEffects, effect: t, ...$(n) });
    Je.createWithPreprocess = (e, t, n) =>
      new Je({
        schema: t,
    ...
    bt.create = (e, t) => new bt({ innerType: e, typeName: H.ZodOptional, ...$(t) });
    ...
    zt.create = (e, t) => new zt({ innerType: e, typeName: H.ZodNullable, ...$(t) });
    ...
    ar.create = (e) => new ar({ typeName: H.ZodNaN, ...$(e) });
    var am = Symbol('zod_brand'),
      ...
      wr = class extends Y {
        ...
        static create(e, t) {
          return new wr({ in: e, out: t, typeName: H.ZodPipeline });
        }
      },
      rr = class extends Y {
        _parse(e) {
          let t = this._def.innerType._parse(e);
          return (Yn(t) && (t.value = Object.freeze(t.value)), t);
        }
      };
    rr.create = (e, t) => new rr({ innerType: e, typeName: H.ZodReadonly, ...$(t) });
    var zs = (e, t = {}, n) =>
        e
    ...
    var im = (e, t = { message: `Input not instance of ${e.name}` }) =>
      ...
      jm = vt.union([
        vt.object({ message: vt.literal('login') }),
        vt.object({ message: vt.literal('grant'), denied: vt.boolean() }),
        vt.object({ message: vt.literal('createdProject'), projectId: vt.string() }),
      ]),
      Gs = (e) => {
        let t = be(),
          n = be();
...
`),
                ...
                a.createElement(
                  ...
                  a.createElement(
                    ...
                    s
                      ?.split('')
                      .map((y, w) =>
                        a.createElement('li', { key: `${w}-${y}` }, y.replace(/[^A-Z0-9]/, ''))
                      )
                  )
                ),
                a.createElement(
      ...
      Qm = k.div({
        ...
        span: { display: 'inline-flex', alignItems: 'center', gap: 5, padding: '0 5px' },
      }),
      Jm = ({ onNext: e, onUninstall: t }) =>
        a.createElement(
          pe,
            ...
            a.createElement(
              ...
              a.createElement(
                ...
                a.createElement(
                  'div',
                  null,
                  a.createElement('span', null, 'Light mode', a.createElement(Ji, { size: 10 })),
      ...
      Xm = ({ setAccessToken: e, setCreatedProjectId: t, hasProjectId: n }) => {
        ...
        if (r === 'welcome' && !n)
          return a.createElement(Jm, { onNext: () => i('signin'), onUninstall: d });
...
`,
      ...
      Kr = k.div({ width: '100%', display: 'flex', flexDirection: 'column', gap: 8 }),
      xa = k.pre(({ theme: e }) => ({
        margin: 0,
        padding: '10px 12px',
        fontSize: '12px',
            ...
            a.createElement(
              ...
              r
                ? a.createElement(
                    ...
                    a.createElement(xa, null, 'git config user.email "you@example.com"'),
                    a.createElement(
                      j,
                      { muted: !0, small: !0 },
                      a.createElement(
                ...
                : a.createElement(
                    ...
                    a.createElement(
                      ...
                      a.createElement(
                        'li',
                        null,
                        t ? a.createElement(Yr, null) : a.createElement(qr, null),
                        a.createElement(
                          Kr,
                          null,
                          a.createElement('span', null, 'Initialize a Git repository'),
                          t && a.createElement(xa, null, 'git init')
                        )
                      ),
                      a.createElement(
                        'li',
                        null,
                        n ? a.createElement(Yr, null) : a.createElement(qr, null),
                        a.createElement(
                          Kr,
                          null,
                          a.createElement('span', null, 'Stage all files'),
                          n && a.createElement(xa, null, 'git add .')
                        )
                      ),
                      a.createElement(
                        'li',
                        ...
                        a.createElement(
                          ...
                          n && a.createElement(xa, null, 'git commit -m "Initial commit"')
                        )
                      )
                    ),
                    a.createElement(
...
`),
      s4 = ({ projectId: e, configFile: t, goToNext: n }) => {
        ...
        let [{ data: r, fetching: i, error: l }] = sl({ query: o4, variables: { projectId: e } });
        return a.createElement(
          pe,
          {
            footer: a.createElement(
              ...
              a.createElement(We, { push: !0 }, a.createElement(vr, null))
            ),
          },
          a.createElement(
            de,
...
`),
      h4 = ({ createdProjectId: e, setCreatedProjectId: t, onUpdateProject: n }) => {
        let r = a.useCallback(
          async (i) => {
            await n(i);
          },
              ...
              !r &&
                ...
                a.createElement(
                  ...
                  a.createElement(
                    Vo,
                    null,
                    a.createElement(Na, null, 'Accounts'),
                    a.createElement(
                      Fa,
                      null,
                      a.createElement(Ye, { appearance: 'secondary', isLoading: !0 }),
                      a.createElement(Ye, { appearance: 'secondary', isLoading: !0 }),
                      a.createElement(Ye, { appearance: 'secondary', isLoading: !0 }),
                      a.createElement(Ye, { appearance: 'secondary', isLoading: !0 }),
                      a.createElement(Ye, { appearance: 'secondary', isLoading: !0 })
                  ...
                  a.createElement(
                    Ho,
                    null,
                    a.createElement(Na, null, 'Projects'),
                    a.createElement(
                      Fa,
                    ...
                    a.createElement(
                      ...
                      r.viewer.accounts?.map((h) =>
                        a.createElement(Ye, {
                          ...
                          left: a.createElement(g4, { src: h.avatarUrl ?? void 0, size: 'tiny' }),
                          onClick: () => u(h),
                          active: s === h.id,
                        })
                      )
                      ...
                      c?.projects?.map(
                        (h) =>
                          ...
                          a.createElement(Ye, {
                            ...
                            key: h.id,
                            title: h.name,
                            right: a.createElement(Ec, { 'aria-label': h.name }),
                            onClick: () => v(h),
                            disabled: m,
                          })
                      )
    ...
    var y4 = () =>
      ...
      Js = De(Qs),
      oa = () => ft(Js, 'RunBuild'),
      k4 = ({ children: e, watchState: t = Qs }) => a.createElement(Js.Provider, { value: t }, e),
      Zi = {
    ...
    function C4(e) {
      ...
      return (
        e?.forEach((n) => {
          ...
          if (!r) {
            t[n.story.storyId] = Zi[n.status];
            return;
          }
          t[n.story.storyId] = w4(r, Zi[n.status]);
        }),
    ...
    function S4(e, { shouldSwitchToLastBuildOnBranch: t, lastBuildOnBranchId: n, storyId: r }) {
    ...
    var Do = {
      ...
      Xs = ({ children: e, billingUrl: t, suspensionReason: n = 'OTHER' }) => {
        Ve('Errors', 'AccountSuspended');
        let { heading: r, message: i, action: l } = Do[n] || Do.OTHER;
        return a.createElement(
          pe,
          { footer: null },
          a.createElement(
    ...
    var N4 = e0('function'),
      F4 = (e) => e === null,
      zo = (e) => Object.prototype.toString.call(e).slice(8, -1) === 'RegExp',
      Uo = (e) => !M4(e) && !F4(e) && (N4(e) || typeof e == 'object'),
      M4 = e0('undefined');
    function A4(e, t) {
      let { length: n } = e;
      if (n !== t.length) return !1;
      for (let r = n; r-- !== 0; ) if (!Fe(e[r], t[r])) return !1;
      return !0;
    }
    function L4(e, t) {
    ...
    function T4(e, t) {
      ...
      for (let n of e.entries()) if (!Fe(n[1], t.get(n[0]))) return !1;
      return !0;
    }
    function _4(e, t) {
      if (e.size !== t.size) return !1;
    ...
    function Fe(e, t) {
      ...
      if (e && Uo(e) && t && Uo(t)) {
        ...
        if (e instanceof Set && t instanceof Set) return _4(e, t);
        if (ArrayBuffer.isView(e) && ArrayBuffer.isView(t)) return L4(e, t);
        if (zo(e) && zo(t)) return e.source === t.source && e.flags === t.flags;
        ...
        for (let i = n.length; i-- !== 0; ) {
          let l = n[i];
          if (!(l === '_owner' && e.$$typeof) && !Fe(e[l], t[l])) return !1;
        }
        return !0;
      }
    ...
    function A(e) {
      ...
      return A.array(e) ? 'Array' : A.plainFunction(e) ? 'Function' : Cr(e) || 'Object';
    }
    A.array = Array.isArray;
    A.arrayOf = (e, t) => (!A.array(e) && !A.function(t) ? !1 : e.every((n) => t(n)));
    A.asyncGeneratorFunction = (e) => Cr(e) === 'AsyncGeneratorFunction';
    A.asyncFunction = tt('AsyncFunction');
    A.bigint = yn('bigint');
    A.boolean = (e) => e === !0 || e === !1;
    A.date = tt('Date');
    ...
    A.generatorFunction = tt('GeneratorFunction');
    ...
    A.weakMap = tt('WeakMap');
    A.weakSet = tt('WeakSet');
    var Z = A;
    function P4(...e) {
      return e.every((t) => Z.string(t) || Z.array(t) || Z.plainObject(t));
    }
    function V4(e, t, n) {
      return t0(e, t)
        ? [e, t].every(Z.array)
          ? !e.some(Yo(n)) && t.some(Yo(n))
          : [e, t].every(Z.plainObject)
            ? !Object.entries(e).some(qo(n)) && Object.entries(t).some(qo(n))
            : t === n
        : !1;
    }
    function $o(e, t, n) {
      let { actual: r, key: i, previous: l, type: o } = n,
        s = st(e, i),
        d = st(t, i),
        c = [s, d].every(Z.number) && (o === 'increased' ? s < d : s > d);
      return (Z.undefined(r) || (c = c && d === r), Z.undefined(l) || (c = c && s === l), c);
    }
    function Wo(e, t, n) {
      let { key: r, type: i, value: l } = n,
        ...
        d = i === 'added' ? o : s,
        c = i === 'added' ? s : o;
      if (!Z.nullOrUndefined(l)) {
        if (Z.defined(d)) {
          if (Z.array(d) || Z.plainObject(d)) return V4(d, c, l);
        } else return Fe(c, l);
        return !1;
      }
      return [o, s].every(Z.array)
        ? !c.every(cl(d))
        : [o, s].every(Z.plainObject)
          ? H4(Object.keys(d), Object.keys(c))
          : ![o, s].every((u) => Z.primitive(u) && Z.defined(u)) &&
            (i === 'added' ? !Z.defined(o) && Z.defined(s) : Z.defined(o) && !Z.defined(s));
    }
    function Go(e, t, { key: n } = {}) {
      let r = st(e, n),
        i = st(t, n);
      if (!t0(r, i)) throw new TypeError('Inputs have different types');
      if (!P4(r, i)) throw new TypeError("Inputs don't have length");
      return ([r, i].every(Z.plainObject) && ((r = Object.keys(r)), (i = Object.keys(i))), [r, i]);
    }
    function qo(e) {
      return ([t, n]) =>
        Z.array(e)
          ? Fe(e, n) || e.some((r) => Fe(r, n) || (Z.array(n) && cl(n)(r)))
          : Z.plainObject(e) && e[t]
            ? !!e[t] && Fe(e[t], n)
            : Fe(e, n);
    }
    ...
    function Yo(e) {
      return (t) => (Z.array(e) ? e.some((n) => Fe(n, t) || (Z.array(t) && cl(t)(n))) : Fe(e, t));
    }
    function Mn(e, t) {
      return Z.array(e) ? e.some((n) => Fe(n, t)) : Fe(e, t);
    }
    function cl(e) {
      return (t) => e.some((n) => Fe(n, t));
    }
    function t0(...e) {
      return e.every(Z.array) || e.every(Z.number) || e.every(Z.plainObject) || e.every(Z.string);
    }
    function st(e, t) {
      return Z.plainObject(e) || Z.array(e)
        ? Z.string(t)
    ...
    function ir(e, t) {
      if ([e, t].some(Z.nullOrUndefined)) throw new Error('Missing required parameters');
      if (![e, t].every((n) => Z.plainObject(n) || Z.array(n)))
        throw new Error('Expected plain objects or array');
      return {
        added: (n, r) => {
          try {
            return Wo(e, t, { key: n, type: 'added', value: r });
          } catch {
            return !1;
          }
        },
        changed: (n, r, i) => {
          try {
            let l = st(e, n),
              ...
              d = Z.defined(i);
            if (s || d) {
              let c = d ? Mn(i, l) : !Mn(r, l),
                u = Mn(r, o);
              return c && u;
            }
            return [l, o].every(Z.array) || [l, o].every(Z.plainObject) ? !Fe(l, o) : l !== o;
          } catch {
            return !1;
          }
        },
        changedFrom: (n, r, i) => {
          if (!Z.defined(n)) return !1;
          try {
            let l = st(e, n),
              o = st(t, n),
              s = Z.defined(i);
            return Mn(r, l) && (s ? Mn(i, o) : !s);
          } catch {
            return !1;
          }
        },
        decreased: (n, r, i) => {
          if (!Z.defined(n)) return !1;
          try {
            return $o(e, t, { key: n, actual: r, previous: i, type: 'decreased' });
          } catch {
            return !1;
          }
        },
        ...
        increased: (n, r, i) => {
          if (!Z.defined(n)) return !1;
          try {
            return $o(e, t, { key: n, actual: r, previous: i, type: 'increased' });
          } catch {
            return !1;
          }
        },
        removed: (n, r) => {
          try {
            return Wo(e, t, { key: n, type: 'removed', value: r });
          } catch {
            return !1;
          }
        },
    ...
    var j4 = ht(Od(), 1),
      n0 = ht(Id(), 1);
    function D4(e, ...t) {
      if (!Z.plainObject(e)) throw new TypeError('Expected an object');
      let n = {};
    ...
    var Ma = ht(Ui(), 1),
      Jr = ht(Ui(), 1),
      N = ht(Pd()),
      sa = typeof window < 'u' && typeof document < 'u' && typeof navigator < 'u',
      U4 = (function () {
        for (var e = ['Edge', 'Trident', 'Firefox'], t = 0; t < e.length; t += 1)
          if (sa && navigator.userAgent.indexOf(e[t]) >= 0) return 1;
        return 0;
      })();
    function $4(e) {
      var t = !1;
    ...
    function da(e) {
      ...
      var t = $t(e),
        ...
        r = t.overflowX,
        i = t.overflowY;
      return /(auto|scroll|overlay)/.test(n + i + r) ? e : da(ul(e));
    }
    function r0(e) {
      return e && e.referenceNode ? e.referenceNode : e;
    }
    var Ko = sa && !!(window.MSInputMethodContext && document.documentMode),
      Qo = sa && /MSIE 10/.test(navigator.userAgent);
    function bn(e) {
      return e === 11 ? Ko : e === 10 ? Qo : Ko || Qo;
    }
    function hn(e) {
      ...
      return !r || r === 'BODY' || r === 'HTML'
        ...
        : ['TH', 'TD', 'TABLE'].indexOf(n.nodeName) !== -1 && $t(n, 'position') === 'static'
          ? hn(n)
          : n;
    }
    function Y4(e) {
    ...
    function Oi(e) {
      return e.parentNode !== null ? Oi(e.parentNode) : e;
    }
    function lr(e, t) {
      ...
      var s = Oi(e);
      return s.host ? lr(s.host, t) : lr(e, Oi(t).host);
    }
    function fn(e) {
    ...
    function i0(e) {
      ...
      return { height: Xo('Height', t, n, r), width: Xo('Width', t, n, r) };
    }
    var Q4 = function (e, t) {
    ...
    function Ii(e) {
      ...
      var i = { left: t.left, top: t.top, width: t.right - t.left, height: t.bottom - t.top },
        l = e.nodeName === 'HTML' ? i0(e.ownerDocument) : {},
      ...
      if (d || c) {
        var u = $t(e);
        ((d -= Jo(u, 'x')), (c -= Jo(u, 'y')), (i.width -= d), (i.height -= c));
      }
      return Mt(i);
    }
    function ml(e, t) {
      ...
      return ((r && !n ? t.contains(s) : t === s && s.nodeName !== 'BODY') && (m = K4(m, t)), m);
    }
    function X4(e) {
      var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1,
        ...
        o = t ? 0 : fn(n),
        s = t ? 0 : fn(n, 'left'),
        d = { top: o - r.top + r.marginTop, left: s - r.left + r.marginLeft, width: i, height: l };
      return Mt(d);
    }
    function l0(e) {
      var t = e.nodeName;
    ...
    function o0(e) {
      ...
      for (var t = e.parentElement; t && $t(t, 'transform') === 'none'; ) t = t.parentElement;
    ...
    function pl(e, t, n, r) {
      ...
      if (r === 'viewport') l = X4(o, i);
        ...
        var s = void 0;
        r === 'scrollParent'
          ? ((s = da(ul(t))), s.nodeName === 'BODY' && (s = e.ownerDocument.documentElement))
          : r === 'window'
            ? (s = e.ownerDocument.documentElement)
            : (s = r);
        var d = ml(s, o, i);
        if (s.nodeName === 'HTML' && !l0(o)) {
          var c = i0(e.ownerDocument),
            u = c.height,
            m = c.width;
    ...
    function s0(e, t, n, r, i) {
      ...
      var o = pl(n, r, l, i),
        ...
        d = Object.keys(s)
          .map(function (p) {
            return $e({ key: p }, s[p], { area: ep(s[p]) });
          })
          .sort(function (p, v) {
      ...
      return (
        r.forEach(function (i) {
          ...
          i.enabled &&
            ...
            (t.offsets.reference = Mt(t.offsets.reference)),
            (t = l(t, i)));
        }),
        t
      );
    ...
    function np() {
      if (!this.state.isDestroyed) {
        ...
        ((e.offsets.reference = d0(
          ...
          (e.offsets.popper = u0(this.popper, e.offsets.reference, e.placement)),
          (e.offsets.popper.position = this.options.positionFixed ? 'fixed' : 'absolute'),
          (e = m0(this.modifiers, e)),
    ...
    function f0(e, t, n, r) {
      ...
      (l.addEventListener(t, n, { passive: !0 }), i || f0(da(l.parentNode), t, n, r), r.push(l));
    }
    function rp(e, t, n, r) {
      ((n.updateBound = r), h0(e).addEventListener('resize', n.updateBound, { passive: !0 }));
      var i = da(e);
      return (
        f0(i, 'scroll', n.updateBound, n.scrollParents),
        (n.scrollElement = i),
        (n.eventsEnabled = !0),
        n
      );
    ...
    function ip() {
      this.state.eventsEnabled ||
        (this.state = rp(this.reference, this.options, this.state, this.scheduleUpdate));
    }
    function lp(e, t) {
      return (
    ...
    function op() {
      this.state.eventsEnabled &&
        (cancelAnimationFrame(this.scheduleUpdate), (this.state = lp(this.reference, this.state)));
    }
    function fl(e) {
    ...
    function dp(e) {
      return (
        Ri(e.instance.popper, e.styles),
        sp(e.instance.popper, e.attributes),
        e.arrowElement && Object.keys(e.arrowStyles).length && Ri(e.arrowElement, e.arrowStyles),
        e
      );
    }
    function cp(e, t, n, r, i) {
      var l = d0(i, t, e, n.positionFixed),
        o = s0(n.placement, l, t, e, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
      return (
        t.setAttribute('x-placement', o),
        Ri(t, { position: n.positionFixed ? 'fixed' : 'absolute' }),
        n
      );
    }
    function up(e, t) {
    ...
    var mp = sa && /Firefox/i.test(navigator.userAgent);
    function pp(e, t) {
      var n = t.x,
        r = t.y,
        i = e.offsets.popper,
        l = ca(e.instance.modifiers, function (f) {
    ...
    function hp(e, t) {
      var n;
      if (!g0(e.instance.modifiers, 'arrow', 'keepTogether')) return e;
      var r = t.element;
      if (typeof r == 'string') {
      ...
      (s[v] - g < o[m] && (e.offsets.popper[m] -= o[m] - (s[v] - g)),
        ...
        (e.offsets.popper = Mt(e.offsets.popper)));
      var y = s[m] + s[c] / 2 - g / 2,
      ...
      return (
        ...
        (e.arrowElement = r),
        (e.offsets.arrow = ((n = {}), gn(n, m, Math.round(f)), gn(n, p, ''), n)),
        e
      );
    }
    function fp(e) {
    ...
    function e1(e) {
      var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1,
        n = Xr.indexOf(e),
        r = Xr.slice(n + 1).concat(Xr.slice(0, n));
      return t ? r.reverse() : r;
    }
    var ei = { FLIP: 'flip', CLOCKWISE: 'clockwise', COUNTERCLOCKWISE: 'counterclockwise' };
    function gp(e, t) {
      if (p0(e.instance.modifiers, 'inner') || (e.flipped && e.placement === e.originalPlacement))
        return e;
      var n = pl(
          e.instance.popper,
        ...
        o.forEach(function (s, d) {
          ...
          (p || b || C) &&
            ...
            (e.offsets.popper = $e(
              {},
              e.offsets.popper,
              u0(e.instance.popper, e.offsets.reference, e.placement)
            )),
            (e = m0(e.instance.modifiers, e, 'flip')));
        }),
        e
      );
    }
    ...
    function bp(e, t, n, r) {
      ...
      var d = /\s*,\s*|\s+/,
        c =
          s !== -1
            ? [o.slice(0, s).concat([o[s].split(d)[0]]), [o[s].split(d)[1]].concat(o.slice(s + 1))]
            : [o];
      return (
    ...
    function kp(e, t) {
      ...
      var r = hl('transform'),
        ...
        s = i[r];
      ((i.top = ''), (i.left = ''), (i[r] = ''));
      var d = pl(e.instance.popper, e.instance.reference, t.padding, n, e.positionFixed);
    ...
    function Cp(e) {
      if (!g0(e.instance.modifiers, 'hide', 'preventOverflow')) return e;
    ...
    var xp = {
        ...
        applyStyle: { order: 900, enabled: !0, fn: dp, onLoad: cp, gpuAcceleration: void 0 },
      },
      Np = {
        placement: 'bottom',
        positionFixed: !1,
      ...
      Sr = (function () {
        function e(t, n) {
          ...
          (Q4(this, e),
            ...
            Object.keys($e({}, e.Defaults.modifiers, i.modifiers)).forEach(function (o) {
              r.options.modifiers[o] = $e(
                {},
            ...
            (this.modifiers = Object.keys(this.options.modifiers)
              .map(function (o) {
                return $e({ name: o }, r.options.modifiers[o]);
              })
              .sort(function (o, s) {
    ...
    var t1 = Sr,
      Bi = ht(Ui()),
      Fp = ['innerHTML', 'ownerDocument', 'style', 'attributes', 'nodeValue'],
      Mp = [
        'Array',
        'ArrayBuffer',
        'AsyncFunction',
      ...
      Ap = ['bigint', 'boolean', 'null', 'number', 'string', 'symbol', 'undefined'];
    function xr(e) {
    ...
    L.asyncFunction = nt('AsyncFunction');
    L.bigint = En('bigint');
    ...
    L.generatorFunction = nt('GeneratorFunction');
    ...
    L.weakMap = nt('WeakMap');
    L.weakSet = nt('WeakSet');
    var I = L;
    function y0(e) {
      return function (t) {
        return typeof t === e;
    ...
    var _p = y0('function'),
      ...
      a1 = function (e) {
        return !Op(e) && !Zp(e) && (_p(e) || typeof e == 'object');
      },
      Op = y0('undefined'),
      Pi = function (e) {
    ...
    function Ip(e, t) {
      var n = e.length;
      if (n !== t.length) return !1;
      for (var r = n; r-- !== 0; ) if (!Ze(e[r], t[r])) return !1;
      return !0;
    }
    function Rp(e, t) {
      if (e.byteLength !== t.byteLength) return !1;
    ...
    function Bp(e, t) {
      ...
      if (e.size !== t.size) return !1;
      try {
        for (var o = Pi(e.entries()), s = o.next(); !s.done; s = o.next()) {
          var d = s.value;
      ...
      try {
        for (var c = Pi(e.entries()), u = c.next(); !u.done; u = c.next()) {
          var d = u.value;
          if (!Ze(d[1], t.get(d[0]))) return !1;
        }
      } catch (m) {
        i = { error: m };
      } finally {
    ...
    function Pp(e, t) {
      ...
      if (e.size !== t.size) return !1;
      try {
        for (var i = Pi(e.entries()), l = i.next(); !l.done; l = i.next()) {
          var o = l.value;
      ...
      return b0(e, t)
        ? [e, t].every(I.array)
          ...
          : [e, t].every(I.plainObject)
            ? !Object.entries(e).some(o1(n)) && Object.entries(t).some(o1(n))
            : t === n
        : !1;
    }
    function r1(e, t, n) {
      ...
      return (I.undefined(r) || (c = c && d === r), I.undefined(l) || (c = c && s === l), c);
    }
    function i1(e, t, n) {
      var r = n.key,
        i = n.type,
    ...
    function l1(e, t, n) {
      var r = n === void 0 ? {} : n,
        ...
        l = dt(e, i),
        o = dt(t, i);
      if (!b0(l, o)) throw new TypeError('Inputs have different types');
      if (!Vp(l, o)) throw new TypeError("Inputs don't have length");
      return ([l, o].every(I.plainObject) && ((l = Object.keys(l)), (o = Object.keys(o))), [l, o]);
    }
    function o1(e) {
      return function (t) {
        var n = t[0],
        ...
        return I.array(e)
          ? Ze(e, r) ||
              e.some(function (i) {
                return Ze(i, r) || (I.array(r) && gl(r)(i));
              })
          : I.plainObject(e) && e[n]
            ? !!e[n] && Ze(e[n], r)
            : Ze(e, r);
    ...
    function s1(e) {
      return function (t) {
        return I.array(e)
          ? e.some(function (n) {
              return Ze(n, t) || (I.array(t) && gl(t)(n));
            })
          : Ze(e, t);
      };
    }
    ...
    function Dp(e, t) {
      ...
      var n = function (m, p) {
          try {
            return i1(e, t, { key: m, type: 'added', value: p });
          } catch {
            return !1;
          }
        },
        r = function (m, p, v) {
          try {
            var g = dt(e, m),
              ...
              b = I.defined(v);
            if (w || b) {
              var h = b ? An(v, g) : !An(p, g),
                f = An(p, y);
              return h && f;
            }
            return [g, y].every(I.array) || [g, y].every(I.plainObject) ? !Ze(g, y) : g !== y;
          } catch {
            return !1;
          }
        },
        ...
        o = function (m, p, v) {
          if (!I.defined(m)) return !1;
          try {
            return r1(e, t, { key: m, actual: p, previous: v, type: 'decreased' });
          } catch {
            return !1;
          }
        },
        ...
        c = function (m, p, v) {
          if (!I.defined(m)) return !1;
          try {
            return r1(e, t, { key: m, actual: p, previous: v, type: 'increased' });
          } catch {
            return !1;
          }
        },
        u = function (m, p) {
          try {
            return i1(e, t, { key: m, type: 'removed', value: p });
          } catch {
            return !1;
          }
        };
    ...
    function u1(e, t, n) {
      return (
        Xp(e, n),
        function (r, i, l) {
          for (var o = arguments.length, s = new Array(o > 3 ? o - 3 : 0), d = 3; d < o; d++)
            s[d - 3] = arguments[d];
          return Kp(t, r, i, l)
            ? Qp(r, i)
    ...
    var w0 = (function (e) {
      ...
      var t = ha(n);
      function n() {
        return (ua(this, n), t.apply(this, arguments));
      }
      return (
        ma(n, [
          {
            ...
            value: function () {
              rt() && (this.node || this.appendNode(), Ln || this.renderPortal());
            },
          },
          {
            key: 'componentDidUpdate',
            value: function () {
              rt() && (Ln || this.renderPortal());
            },
          },
          {
            ...
            value: function () {
              !rt() ||
                !this.node ||
                (Ln || xn.unmountComponentAtNode(this.node),
                this.node &&
          ...
          },
          {
            ...
            value: function () {
              ...
              var r = this.props,
                i = r.children,
                l = r.setRef;
              if ((this.node || this.appendNode(), Ln)) return xn.createPortal(i, this.node);
              var o = xn.unstable_renderSubtreeIntoContainer(
                this,
          ...
          },
          {
            key: 'render',
            value: function () {
              return Ln ? this.renderReact16() : null;
            },
          },
        ]),
        n
              ...
              return (
                ...
                a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      'svg',
                      { width: w, height: b, version: '1.1', xmlns: 'http://www.w3.org/2000/svg' },
    ...
    S0.propTypes = { handleClick: N.default.func.isRequired, styles: N.default.object.isRequired };
    function x0(e) {
      var t = e.content,
        n = e.footer,
        r = e.handleClick,
        ...
        c = {
          content: a.isValidElement(t)
            ? t
            : a.createElement('div', { className: '__floater__content', style: d.content }, t),
        };
      return (
        s &&
          (c.title = a.isValidElement(s)
            ? s
            : a.createElement('div', { className: '__floater__title', style: d.title }, s)),
        n &&
          (c.footer = a.isValidElement(n)
            ? n
            : a.createElement('div', { className: '__floater__footer', style: d.footer }, n)),
        (o || l) &&
          !I.boolean(i) &&
          (c.close = a.createElement(S0, { styles: d.close, handleClick: r })),
        a.createElement(
          'div',
        ...
        ma(n, [
          {
            ...
            get: function () {
              ...
              return (
                ...
                [ee.OPENING, ee.OPEN].indexOf(d) !== -1 && (b = me(me({}, b), g)),
            ...
            value: function () {
              ...
              return (
                i
                  ...
                  : (c.content = a.createElement(x0, this.props)),
                d === ee.OPEN && u.push('__floater__open'),
                o || (c.arrow = a.createElement(C0, this.props)),
                a.createElement(
                  'div',
                  { ref: s, className: u.join(' '), style: this.style },
                  a.createElement('div', { className: '__floater__body' }, c.content, c.arrow)
                )
              );
            },
          },
    ...
    var r3 = { zIndex: 100 };
    function i3(e) {
      var t = (0, Bi.default)(r3, e.options || {});
      return {
        wrapper: {
          cursor: 'help',
          display: 'inline-flex',
      ...
      vl = (function (e) {
        ...
        function n(r) {
          ...
          return (
            ua(this, n),
            (i = t.call(this, r)),
            xe(yt(i), 'setArrowRef', function (l) {
              i.arrowRef = l;
            }),
            xe(yt(i), 'setChildRef', function (l) {
              i.childRef = l;
            }),
            xe(yt(i), 'setFloaterRef', function (l) {
              i.floaterRef = l;
            }),
            xe(yt(i), 'setWrapperRef', function (l) {
              i.wrapperRef = l;
            }),
            xe(yt(i), 'handleTransitionEnd', function () {
            ...
            xe(yt(i), 'handleClick', function () {
              ...
              if (!I.boolean(s)) {
                ...
                (i.event === 'click' || (i.event === 'hover' && c)) &&
                  (Aa({
                    title: 'click',
                    data: [{ event: o, status: u === ee.OPEN ? 'closing' : 'opening' }],
                    debug: i.debug,
                  }),
                  i.toggle());
              }
            }),
            xe(yt(i), 'handleMouseEnter', function () {
              var l = i.props,
                o = l.event,
                s = l.open;
              if (!(I.boolean(s) || ti())) {
            ...
            xe(yt(i), 'handleMouseLeave', function () {
              var l = i.props,
                o = l.event,
                s = l.eventDelay,
                d = l.open;
          ...
          ma(n, [
            ...
            },
            {
              ...
              value: function (r, i) {
                if (rt()) {
                  ...
                  if (r.open !== s) {
                    var v;
                    (I.boolean(s) && (v = s ? ee.OPENING : ee.CLOSING), this.toggle(v));
                  }
                  ((r.wrapperOptions.position !== c.position || r.target !== d) &&
                    this.changeWrapperPosition(this.props),
                    p('status', ee.IDLE) && s
                      ? this.toggle(ee.OPEN)
                      : m('status', ee.INIT, ee.IDLE) && o && this.toggle(ee.OPEN),
                    this.popper && p('status', ee.OPENING) && this.popper.instance.update(),
                    this.floaterRef &&
                      (p('status', ee.OPENING) || p('status', ee.CLOSING)) &&
                      n3(this.floaterRef, 'transitionend', this.handleTransitionEnd),
            ...
            },
            {
              ...
              value: function () {
                ...
                if (l) {
                  ...
                  new t1(this.target, this.wrapperRef, {
            ...
            },
            {
              ...
              get: function () {
                ...
                return r || (rt() && 'ReactFloaterDebug' in window && !!window.ReactFloaterDebug);
              },
            },
            {
              key: 'event',
    ...
    xe(vl, 'propTypes', {
      ...
      children: N.default.node,
      component: u1(N.default.oneOfType([N.default.func, N.default.element]), function (e) {
        return !e.content;
      }),
      content: u1(N.default.node, function (e) {
        return !e.component;
      }),
    ...
    function Nr(e, t, n) {
      if (!e) return Bt();
      let r = (0, n0.default)(e);
      if (r) {
        if (r.isSameNode(Bt())) return n ? document : Bt();
        if (!(r.scrollHeight > r.offsetHeight) && !t) return ((r.style.overflow = 'initial'), Bt());
      }
      return r;
    }
    function Fr(e, t) {
    ...
    function g3(e, t, n) {
      var r;
      if (!e) return 0;
      let { offsetTop: i = 0, scrollTop: l = 0 } = (r = (0, n0.default)(e)) != null ? r : {},
    ...
    function y3(e, t) {
      return !Z.plainObject(e) || !Z.array(t) ? !1 : Object.keys(e).every((n) => t.includes(n));
    }
    function b3(e) {
    ...
    function x3(e, t) {
      let n = (0, Jr.default)(e ?? {}, t ?? {}),
        r = (0, Jr.default)(S3, n.options || {}),
        { width: i } = r;
    ...
    function Zn(e, t) {
      var n, r, i, l, o, s;
      let d = e ?? {},
        c = Ma.default.all([w3, N3(t), d], { isMergeableObject: Z.plainObject }),
        u = x3(t.styles, c.styles),
        m = Fr(Ft(c.target), c.disableScrollParentFix),
        p = Ma.default.all([
          k3,
      ...
      return (
        (p.offset = c.offset),
        (p.styles = (0, Ma.default)((i = p.styles) != null ? i : {}, u.floaterStyles)),
        (p.offset +=
          (o = (l = t.spotlightPadding) != null ? l : c.spotlightPadding) != null ? o : 0),
        c.placementBeacon && p.wrapperOptions && (p.wrapperOptions.placement = c.placementBeacon),
        m && p.options.preventOverflow && (p.options.preventOverflow.boundariesElement = 'window'),
        {
          ...c,
          locale: Ma.default.all([L0, (s = t.locale) != null ? s : {}, c.locale || {}]),
          floaterProps: p,
    ...
    var F3 = {
      ...
      v1 = ['action', 'index', 'lifecycle', 'status'],
      M3 = class {
        constructor(e) {
          (O(this, 'beaconPopper'),
            ...
            O(this, 'setSteps', (i) => {
              ...
              (this.data.set('steps', i),
                o === Q.WAITING && !l && i.length && (s.status = Q.RUNNING),
                this.setState(s));
            }),
            ...
            O(this, 'next', () => {
              let { index: i, status: l } = this.getState();
              l === Q.RUNNING &&
                this.setState(this.getNextState({ action: ie.NEXT, index: i + 1 }));
            }),
            O(this, 'open', () => {
              let { status: i } = this.getState();
              i === Q.RUNNING &&
                this.setState({
                  ...this.getNextState({ action: ie.UPDATE, lifecycle: G.TOOLTIP }),
                });
            }),
            O(this, 'prev', () => {
              let { index: i, status: l } = this.getState();
            ...
            O(this, 'reset', (i = !1) => {
              ...
              l ||
                this.setState({
                  ...
                  status: i ? Q.RUNNING : Q.READY,
                });
            }),
            O(this, 'skip', () => {
              let { status: i } = this.getState();
              i === Q.RUNNING &&
                this.setState({ action: ie.SKIP, lifecycle: G.INIT, status: Q.SKIPPED });
            }),
            O(this, 'start', (i) => {
              let { index: l, size: o } = this.getState();
              this.setState({
                ...this.getNextState({ action: ie.START, index: Z.number(i) ? i : l }, !0),
                status: o ? Q.RUNNING : Q.WAITING,
              });
            }),
            O(this, 'stop', (i = !1) => {
              let { index: l, status: o } = this.getState();
              [Q.FINISHED, Q.SKIPPED].includes(o) ||
                this.setState({
                  ...this.getNextState({ action: ie.STOP, index: l + (i ? 1 : 0) }),
                  status: Q.PAUSED,
                });
            }),
            O(this, 'update', (i) => {
              var l;
              if (!y3(i, v1)) throw new Error(`State is not valid. Valid keys: ${v1.join(', ')}`);
              this.setState({
                ...this.getNextState(
                  { ...this.getState(), ...i, action: (l = i.action) != null ? l : ie.UPDATE },
                  !0
                ),
              });
            }));
          ...
          (this.setState(
            {
              action: ie.INIT,
              controlled: Z.number(n),
              continuous: t,
              index: Z.number(n) ? n : 0,
              lifecycle: G.INIT,
              status: r.length ? Q.READY : Q.IDLE,
            },
            !0
          ),
        ...
        getNextState(e, t = !1) {
          ...
          return {
            ...
            status: p === c ? Q.FINISHED : (l = e.status) != null ? l : u,
          };
        }
        getSteps() {
    ...
    var L3 = class {
      ...
      `)
        ...
        componentDidMount() {
          ...
          setTimeout(() => {
            Z.domElement(this.beacon) && e && this.beacon.focus();
          }, 0);
        }
        ...
        render() {
          let {
            ...
            c = Z.string(i.open) ? i.open : (0, s3.default)(i.open),
      ...
      O3 = class extends Tt {
        constructor() {
          (super(...arguments),
            ...
            O(this, 'handleScroll', () => {
              ...
              } else ia(t, 'sticky') && this.updateState({});
            }),
            O(this, 'handleResize', () => {
        ...
        componentDidMount() {
          let {
            ...
            i = Ft(r);
          ((this.scrollParent = Nr(i ?? document.body, n, !0)),
            (this.isActive = !0),
        ...
        get spotlightStyles() {
          ...
          let { showSpotlight: r } = this.state,
            ...
            p = f3(c, o, i);
          return {
            ...(h1() ? s.spotlightLegacy : s.spotlight),
        ...
        render() {
          ...
          let d = s.overlay;
          h1() && (d = o === 'center' ? s.overlayLegacyCenter : s.overlayLegacy);
          let c = {
            ...
            u = o !== 'center' && t && S(Z3, { styles: this.spotlightStyles });
          if (A0() === 'safari') {
      ...
      I3 = class extends Tt {
        ...
        componentDidMount() {
          ...
          xt() &&
            ...
            (this.node.id = e),
            document.body.appendChild(this.node),
            Tn || this.renderReact15());
        }
        componentDidUpdate() {
          xt() && (Tn || this.renderReact15());
        }
        componentWillUnmount() {
          !xt() ||
            !this.node ||
        ...
        renderReact15() {
          ...
          this.node && Bl(this, e, this.node);
        }
        renderReact16() {
          if (!xt() || !Tn) return null;
          let { children: e } = this.props;
          return this.node ? ba(e, this.node) : null;
        }
        render() {
    ...
    function P3(e) {
      let {
        ...
        { back: E, close: C, last: _, next: F, skip: V } = y,
        D = { primary: C };
      return (
        r &&
          ((D.primary = l ? _ : F),
    ...
    var V3 = P3,
      ...
      j3 = class extends Tt {
        ...
        componentDidMount() {
          ...
          Ut({ title: `step:${t}`, data: [{ key: 'props', value: this.props }], debug: e });
        }
        componentDidUpdate(e) {
          var t;
          let {
            ...
            { changed: v, changedFrom: g } = ir(e, this.props),
          ...
          if (
            (f &&
              (h || E) &&
              r({ ...y, index: e.index, lifecycle: G.COMPLETE, step: e.step, type: Ke.STEP_AFTER }),
            m.placement === 'center' &&
              u === Q.RUNNING &&
              v('index') &&
              n !== ie.START &&
            ...
            let C = Ft(m.target),
              _ = !!C;
            _ && h3(C)
              ? (g('status', Q.READY, Q.RUNNING) || g('lifecycle', G.INIT, G.READY)) &&
                r({ ...y, step: m, type: Ke.STEP_BEFORE })
              : (console.warn(_ ? 'Target not visible' : 'Target not mounted', m),
                r({ ...y, type: Ke.TARGET_NOT_FOUND, step: m }),
                l || p.update({ index: s + (n === ie.PREV ? -1 : 1) }));
          }
          (g('lifecycle', G.INIT, G.READY) &&
            p.update({ lifecycle: p1(m) || w ? G.TOOLTIP : G.BEACON }),
            v('index') &&
              Ut({ title: `step:${d}`, data: [{ key: 'props', value: this.props }], debug: o }),
            v('lifecycle', G.BEACON) && r({ ...y, step: m, type: Ke.BEACON }),
            v('lifecycle', G.TOOLTIP) &&
              (r({ ...y, step: m, type: Ke.TOOLTIP }),
              this.tooltip &&
      ...
      _0 = class extends Tt {
        constructor(e) {
          ...
          ((this.store = A3({ ...e, controlled: r && Z.number(i) })),
        ...
        componentDidUpdate(e, t) {
          ...
          let { action: n, controlled: r, index: i, lifecycle: l, status: o } = this.state,
            ...
            { changed: h } = ir(e, this.props),
            { changed: f, changedFrom: E } = ir(t, this.state),
            C = Zn(u[i], this.props),
            _ = !Fe(p, u),
            F = Z.number(c) && h('stepIndex'),
            V = Ft(C.target);
          if (
            (_ && (g1(u, s) ? g(u) : console.warn('Steps are not valid', u)),
            h('run') && (d ? y(c) : w()),
            F)
          ) {
            let X = Z.number(m) && m < c ? ie.NEXT : ie.PREV;
          ...
          !r &&
            ...
            this.callback({ ...this.state, type: Ke.TARGET_NOT_FOUND, step: C }));
          let D = { ...this.state, index: i, step: C };
          if (f('action', [ie.NEXT, ie.PREV, ie.SKIP, ie.CLOSE]) && f('status', Q.PAUSED)) {
            let X = Zn(u[t.index], this.props);
            this.callback({
              ...D,
              index: t.index,
          ...
          if (f('status', [Q.FINISHED, Q.SKIPPED])) {
            let X = Zn(u[t.index], this.props);
            (r ||
              this.callback({
                ...D,
              ...
              this.callback({ ...D, type: Ke.TOUR_END, step: X, index: t.index }),
              v());
          } else
            E('status', [Q.IDLE, Q.READY], Q.RUNNING)
              ? this.callback({ ...D, type: Ke.TOUR_START })
              : (f('status') || f('action', ie.RESET)) &&
                this.callback({ ...D, type: Ke.TOUR_STATUS });
          (this.scrollToStep(t),
            C.placement === 'center' &&
              o === Q.RUNNING &&
              l === G.INIT &&
    ...
    var D3 = _0,
      ...
      dr = ([e, ...t]) => t.reduce((n, r) => (y1.indexOf(r) > y1.indexOf(n) ? r : n), e);
    function z3(e) {
      return (e.FAILED ?? 0) > 0
        ? 'FAILED'
        : (e.IN_PROGRESS ?? 0) > 0
      ...
      let {
          ...
          (m, p) => (
            ...
            p.comparisons?.forEach(({ browser: v, result: g }) => {
              m.resultsByBrowser[v.id] = dr([g ?? void 0, m.resultsByBrowser[v.id]]);
            }),
            p.comparisons?.forEach(({ result: v }) => {
              m.resultsByMode[p.mode.name] = dr([v ?? void 0, m.resultsByMode[p.mode.name]]);
            }),
    ...
    function G3(e) {
      ...
      return (
        e.length &&
          ...
          (c = t
            ? W3(d.comparisons, o)
            : d?.comparisons.find(({ browser: u }) => u.id === o) || d?.comparisons[0]),
          t &&
...
`),
      e7 = ({ projectId: e, storyId: t, gitInfo: n, selectedBuildInfo: r }) => {
        ...
        let d = o && t && o.variables.storyId !== t,
          ...
          u = [
            ...an(Q3, c && 'testsForStory' in c && c.testsForStory ? c.testsForStory.nodes : []),
          ],
          m = c?.committedAt > n.committedAt,
          p = !!c && !m,
          v = !!c && u.every((y) => y.status !== 'IN_PROGRESS'),
          g = an(K3, i?.selectedBuild ?? (v ? i?.project?.lastBuildOnBranch : void 0));
        return {
      ...
      t7 = () => ft(bl, 'Build'),
      R0 = () => {
        let { selectedBuild: e } = ft(bl, 'Build');
      ...
      ni = ({ children: e, watchState: t }) => {
        ...
        return (
          ...
          a.createElement(
            bl.Provider,
            { value: gt(() => t, [JSON.stringify(t?.selectedBuild)]) },
            a.createElement(
              I0.Provider,
      ...
      i7 = k.div({ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }),
      l7 = k.div(({ theme: e }) => ({
        fontSize: 13,
        lineHeight: '18px',
        fontWeight: 700,
      ...
      s7 = k.div({ display: 'flex', justifyContent: 'flex-end', marginTop: 15 }),
      ...
      b1 = 'setFilter',
      c7 = ({ managerApi: e, skipWalkthrough: t, startWalkthrough: n, completeWalkthrough: r }) => {
        let i = Cn(),
          l = Wt(),
          o = l?.selectedTest?.result === 'CHANGED',
          s = l?.selectedTest?.status !== 'ACCEPTED',
          d = JSON.stringify(kn().layout),
          c = be(d);
        (c.current !== d && (window.dispatchEvent(new Event('resize')), (c.current = d)),
          te(() => {
            n();
          }),
          te(() => {
      ...
      B0 = ({ localBuildProgress: e, title: t }) =>
        a.createElement(
          u7,
          { warning: !0 },
          a.createElement(
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(B0, { localBuildProgress: t }),
              e
            )
          )
        )
      ...
      El = {
        ...
        upload: {
          ...
          renderProgress: ({ stepProgress: e }) => {
            ...
            let { value: r, exponent: i } = Vr(n, { output: 'object', round: 1 }),
              { value: l, symbol: o } = Vr(t, { exponent: i, output: 'object', round: 1 });
    ...
    JSON.stringify(h7);
    var P0 = ({ localBuildProgress: e, withEmoji: t = !1, ...n }) => {
        let { emoji: r, renderProgress: i } = El[e.currentStep],
          l = i(e);
    ...
    function Mr({ localBuildProgress: e }) {
      return a.createElement(
        f7,
        { center: !0, small: !0 },
        a.createElement(
          ...
          typeof e.buildProgressPercentage == 'number' &&
            a.createElement(g7, { style: { width: `${e.buildProgressPercentage}%` } })
        ),
        a.createElement(P0, { center: !0, muted: !0, small: !0, localBuildProgress: e })
      );
    }
    var v7 =
      ...
      w7 = k.div(({ theme: e }) => ({
        ...
        color: e.color.warningText,
        background: e.background.warning,
        border: `1px solid ${Oa(0.5, e.color.warningText)}`,
        padding: 15,
        margin: 0,
      })),
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(Mr, { localBuildProgress: e })
            )
          )
        ),
      F7 = ({ isUnchanged: e, localBuildProgress: t, ...n }) => (
      ...
      ji = ({ backgroundColor: e, status: t, thumbnailUrl: n }) =>
        a.createElement(
          ...
          t === 'positive' && a.createElement(Ki, null)
        ),
      E1 = k(j)({ marginBottom: 5 }),
      k1 = ({ onComplete: e, onSkip: t, ranSecondBuild: n = !1 }) => {
            ...
            n
              ? a.createElement(
                  ...
                  a.createElement(
                    Et,
                    null,
                    a.createElement(E1, null, "You're ready to start testing!"),
                    a.createElement(re, { variant: 'solid', size: 'medium', onClick: e }, 'Done'),
              ...
              : a.createElement(
                  ...
                  a.createElement(
                    Et,
                    null,
                    a.createElement(E1, null, "It's time to review changes!"),
                    a.createElement(
                      re,
                      { variant: 'solid', size: 'medium', onClick: e },
                      'Take a tour'
      ...
      L7 = ({ isRunning: e, localBuildProgress: t, startBuild: n, onSkip: r }) => (
          ...
          a.createElement(
            ...
            t
              ? a.createElement(
                  ...
                  a.createElement(Mr, { localBuildProgress: t })
                )
              : a.createElement(
                  ne,
                  null,
                  ...
                  a.createElement(
                    ...
                    a.createElement(re, { onClick: r, link: !0 }, 'Skip walkthrough')
                  )
                )
          )
        )
      ...
      Z7 = ({
        ...
        let { isRunning: s, startBuild: d } = oa(),
        ...
        return t?.currentStep === 'error'
          ? a.createElement(
              ...
              a.createElement(
                Et,
                null,
                a.createElement(re, { variant: 'solid', size: 'medium', onClick: d }, 'Try again'),
          ...
          : t?.currentStep === 'limited'
            ...
            : c && (!t || (t && s))
              ...
              : t?.currentStep === 'complete' && !m && !w
                ? i
                  ? a.createElement(k1, { onComplete: l, onSkip: o })
                  : a.createElement(_7, { onCatchAChange: y, onSkip: o })
                : m && !i
                  ? a.createElement(F7, {
                      isRunning: s,
                  ...
                  : i
                    ? a.createElement(k1, { onComplete: l, onSkip: o, ranSecondBuild: m && w })
                    : null;
      },
      O7 = k.div(({ theme: e }) => ({
      ...
      I7 = Ct({ from: { transform: 'rotate(0deg)' }, to: { transform: 'rotate(359deg)' } }),
      R7 = k(ms)({ animation: `${I7} 1s linear infinite` }),
      La = { width: 10, marginRight: 8 },
      C1 = k.button(({ isWarning: e, onClick: t, theme: n }) => {
      ...
      S1 = k.div(({ isWarning: e, percentage: t, theme: n }) => {
      ...
      Ta = k.div({ lineHeight: '21px', padding: '4px 0' }),
      ...
      j7 = ({ localBuildProgress: e, expanded: t = !1 }) => {
        ...
        let r = ['aborted', 'error'].includes(e.currentStep),
          i = Hi.map((l) => {
            let { startedAt: o, completedAt: s } = e.stepProgress[l],
              ...
              c = d && r,
              u = !o,
              m = { ...El[l], isCurrent: d, isFailed: c, isPending: u };
            return c
              ? { ...m, icon: a.createElement(ln, { style: La }), renderLabel: m.renderProgress }
              : d
                ? { ...m, icon: a.createElement(R7, { style: La }), renderLabel: m.renderProgress }
                : u
                  ? { ...m, icon: a.createElement(Ac, { style: La }), renderLabel: m.renderName }
                  : {
                      ...m,
                      icon: a.createElement(Ki, { style: La }),
        ...
        return a.createElement(
          ...
          a.createElement(
            V7,
            null,
            i.map(({ icon: l, isCurrent: o, isFailed: s, isPending: d, key: c, renderLabel: u }) =>
              a.createElement(
                H7,
      ...
      D7 = ({
        ...
        if (n) {
          ...
          return a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(S1, { percentage: n.buildProgressPercentage, isWarning: m }),
              a.createElement(
                Ta,
                null,
                a.createElement(P0, { localBuildProgress: n, withEmoji: !0 })
              ),
              u
                ? a.createElement(
                    ct,
          ...
          return i
            ? r
              ...
              : a.createElement(
                  ...
                  ' ',
                  a.createElement(Zt, { withArrow: !0, onClick: i }, 'Switch to newer snapshot')
                )
            : a.createElement(
                Ta,
                null,
        ...
        return a.createElement(C1, { onClick: i }, a.createElement(S1, { percentage: 100 }), d());
      },
      z7 = ({ onClose: e }) =>
        a.createElement(
          vs,
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(el, { onClick: e }, a.createElement(Xi, { 'aria-label': 'Close' }))
            ),
          ...
          a.createElement(
            bi,
            null,
            a.createElement(Va, null, 'Bounding box', a.createElement(mo, null)),
            a.createElement(
              'dl',
              null,
      ...
      j0 = De(H0),
      D0 = () => ft(j0, 'ReviewTest'),
      U7 = ({ children: e, watchState: t = H0 }) => a.createElement(j0.Provider, { value: t }, e),
      $7 = k.div(
        ({ theme: e }) => ({
          position: 'relative',
          display: 'flex',
      ...
      q7 = ({
        ...
        let p = Cn(),
          ...
          g = r === 'CAPTURE_ERROR',
          y = v && !!d,
          w = v ? { as: 'a', href: n, target: '_blank', title: 'View on Chromatic.com' } : {},
          b = v && c,
          h = y && u,
          [f, E] = a.useState(!1),
          [C, _] = a.useState(!1),
          ...
          [D, X] = a.useState(!1),
          oe = o ? C : f,
          ge = G7({ comparisonImageLoaded: F, focusImageLoaded: D, showDiff: b, showFocus: h });
        return a.createElement(
          $7,
          { ...m, ...w },
          i &&
      ...
      U0 = ({ status: e }) => a.createElement(z0, { status: e }),
      K7 = k.div({
        position: 'relative',
        display: 'inline-flex',
        justifyContent: 'center',
      ...
      $0 = ({ status: e, children: t }) =>
        a.createElement(K7, null, t, a.createElement(z0, { overlay: !0, status: e })),
      N1 = {
        CHROME: a.createElement(qs, { alt: 'Chrome' }),
        FIREFOX: a.createElement(Ys, { alt: 'Firefox' }),
        SAFARI: a.createElement(Ks, { alt: 'Safari' }),
      ...
      J7 = ({ isAccepted: e, selectedBrowser: t, browserResults: n, onSelectBrowser: r }) => {
        let i = dr(n.map(({ result: s }) => s));
        if (!i) return null;
        let l = N1[t.key];
        !e && i !== 'EQUAL' && n.length >= 2 && (l = a.createElement($0, { status: i }, l));
        let o =
          n.length > 1 &&
          n.map(({ browser: s, result: d }) => ({
            ...
            id: s.id,
            onClick: () => r(s),
            right: !e && d !== 'EQUAL' && a.createElement(U0, { status: d }),
            icon: N1[s.key],
            title: s.name,
          }));
        return a.createElement(
          ...
          o
            ? a.createElement(
                ...
                a.createElement(Ji, { size: 10 })
              )
            : a.createElement(Q7, null, l, a.createElement(F1, null, t.name))
        );
      },
      X7 = k.div(({ theme: e }) => ({
        alignItems: 'center',
      ...
      th = ({ isAccepted: e, modeOrder: t, modeResults: n, onSelectMode: r, selectedMode: i }) => {
        let l = dr(n.map(({ result: d }) => d));
        if (!l) return null;
        let o = a.createElement(Fc, null);
        !e && l !== 'EQUAL' && n.length >= 2 && (o = a.createElement($0, { status: l }, o));
        let s =
          n.length > 1 &&
          n
            .map(({ mode: d, result: c }) => ({
              id: d.name,
              title: d.name,
              right: !e && c !== 'EQUAL' && a.createElement(U0, { status: c }),
              onClick: () => r(d),
        ...
        return a.createElement(
          ...
          s
            ? a.createElement(
                ...
                o,
                a.createElement(M1, null, i.name),
                a.createElement(Ji, { size: 10 })
              )
            : a.createElement(X7, null, o, a.createElement(M1, null, i.name))
        );
      },
      A1 = () => {
        let e = Wt(),
        ...
        n === 'outline'
          ...
          : t === 'positive'
            ? {
                ...
                borderColor: Oa(0.5, e.color.positiveText),
                '&:hover': {
                  color: e.color.positiveText,
            ...
            : t === 'warning'
              ? {
                  ...
                  borderColor: Oa(0.5, e.color.warningText),
                  '&:hover': {
                    color: e.color.warningText,
              ...
              : {
                  ...
                  borderWidth: 0,
                  borderColor:
                    e.base === 'light' ? Oa(0.2, e.color.secondary) : It(0.1, e.color.secondary),
                  '&:hover': {
                    color: e.color.lightest,
      ...
      L1 = k.div({ display: 'flex', flexDirection: 'row' }),
      cr = k.div(
        ({ theme: e }) => ({
          width: 12,
          height: 12,
      ...
      ih = k.div(({ theme: e, showDivider: t }) => ({
        ...
        gap: 6,
        '@container (min-width: 300px)': { alignItems: 'flex-start', margin: '15px 10px 15px 0px' },
        '@container (min-width: 800px)': {
          alignItems: 'center',
          ...
          C &&
            a.createElement(
              ...
              a.createElement(
                Ee,
                {
                  tooltip: a.createElement(Ie, { note: r ? 'Hide spotlight' : 'Show spotlight' }),
                  trigger: 'hover',
                  hasChrome: !1,
                },
                a.createElement(
              ...
              a.createElement(
                Ee,
                {
                  tooltip: a.createElement(Ie, { note: n ? 'Hide diff' : 'Show diff' }),
                  trigger: 'hover',
                  hasChrome: !1,
                },
                a.createElement(
          ...
          (f || E) &&
            a.createElement(
              ...
              w &&
                ...
                a.createElement(
                  ...
                  a.createElement(
                    Ee,
                    {
                      tooltip: a.createElement(Ie, { note: 'Batch accept options' }),
                      trigger: 'hover',
                      hasChrome: !1,
                    },
                    a.createElement(
              ...
              w &&
                ...
                a.createElement(
                  ...
                  a.createElement(
                    Ee,
                    {
                      tooltip: a.createElement(Ie, { note: 'Unaccept this story' }),
                      trigger: 'hover',
                      hasChrome: !1,
                    },
                    a.createElement(
                  ...
                  a.createElement(
                    Ee,
                    {
                      tooltip: a.createElement(Ie, { note: 'Batch unaccept options' }),
                      trigger: 'hover',
                      hasChrome: !1,
                    },
                    a.createElement(
              ...
              a.createElement(
                Ee,
                {
                  tooltip: a.createElement(Ie, { note: e ? 'Run new tests' : 'Rerun tests' }),
                  trigger: 'hover',
                  hasChrome: !1,
                },
                a.createElement(
                  ...
                  e ? a.createElement(hr, null) : a.createElement(ms, null)
                )
              )
            )
        );
      ...
      sh = ({ icon: e }) => {
        let { color: t } = Cn();
        return {
          passed: a.createElement(kc, { style: { ...ri, color: t.positive } }),
          changed: a.createElement(wc, { style: { ...ri, color: t.warning } }),
          failed: a.createElement(ln, { style: { ...ri, color: t.negative } }),
        }[e];
      };
    function Di(e) {
    ...
    function tn(e) {
      ...
      return e instanceof Date || (Di(e) === 'object' && t === '[object Date]')
        ? new Date(e.getTime())
    ...
    var fh = {
      ...
      gh = { full: 'h:mm:ss a zzzz', long: 'h:mm:ss a z', medium: 'h:mm:ss a', short: 'h:mm a' },
      vh = {
        full: "{{date}} 'at' {{time}}",
        long: "{{date}} 'at' {{time}}",
        medium: '{{date}}, {{time}}',
      ...
      yh = {
        date: ii({ formats: fh, defaultWidth: 'full' }),
        time: ii({ formats: gh, defaultWidth: 'full' }),
        dateTime: ii({ formats: vh, defaultWidth: 'full' }),
      },
      bh = yh,
      Eh = {
    ...
    var Ch = {
      ...
      Lh = {
        ordinalNumber: Ah,
        era: On({ values: Ch, defaultWidth: 'wide' }),
        quarter: On({
          values: Sh,
          defaultWidth: 'wide',
        ...
        month: On({ values: xh, defaultWidth: 'wide' }),
        day: On({ values: Nh, defaultWidth: 'wide' }),
        dayPeriod: On({
          values: Fh,
          defaultWidth: 'wide',
          formattingValues: Mh,
    ...
    function Jh(e, t, n) {
      ...
      var c = G0(Qh(n), { addSuffix: !!n?.addSuffix, comparison: d }),
        u,
        m;
    ...
    function Xh(e, t) {
      return (Ar(1, arguments), Jh(e, Date.now(), t));
    }
    var e6 = {
    ...
    var n6 = (e) => Xh(e, { addSuffix: !0, locale: { ...W0, formatDistance: t6 } }),
      Rn = k.div(({ theme: e }) => ({
        gridArea: 'info',
        display: 'flex',
        justifySelf: 'start',
                  ...
                  ? (E = a.createElement(
                      ...
                      a.createElement(
                        ...
                        a.createElement(
                          'b',
                          null,
                          a.createElement(Zt, { isButton: !0, onClick: o }, 'View latest snapshot')
                        )
                      ),
                      a.createElement(
                        'span',
                      ...
                      a.createElement(
                        ...
                        a.createElement(
                          ...
                          p
                            ? null
                            : m
                              ? `${(0, Za.default)('change', m, !0)}${c === 'ACCEPTED' ? ' accepted' : ''}`
                              : 'No changes',
                          p ? (0, Za.default)('error', p, !0) : null
                        ),
                        a.createElement(sh, {
                      ...
                      a.createElement(
                        ...
                        v.length > 0 &&
                          a.createElement(
                            'span',
                            { 'data-hidden-large': !0 },
                            (0, Za.default)('mode', v.length, !0),
                            ', ',
                            (0, Za.default)('browser', g.length, !0)
                          ),
                        v.length > 0 &&
  ...
  `,
      ...
      V1 = k.div({ gridArea: 'footer', position: 'sticky', zIndex: 1, bottom: 0 }),
      ...
      s6 = ({
        ...
        let { baselineImageVisible: s, diffVisible: d, focusVisible: c } = gr(),
          { toggleBaselineImage: u, toggleSettings: m, toggleWarnings: p } = vn(),
          v = R0(),
          ...
          _ = w.every(({ result: fe, status: ce }) => fe === 'ADDED' && ce !== 'ACCEPTED'),
          F = !_ && E?.result === 'ADDED' && E?.status !== 'ACCEPTED',
          V = !_ && C?.result === 'ADDED' && E?.result !== 'ADDED' && E?.status !== 'ACCEPTED';
        te(() => {
          ((b.current !== o ||
        ...
        if (t || !w.length)
          return a.createElement(
            B1,
            { hidden: l },
            a.createElement(P1, null, a.createElement(R1, null, D)),
            a.createElement(V1, null, a.createElement(A1, null))
          );
        let X = yl(w),
          { isInProgress: oe } = X,
          ge =
        ...
        return a.createElement(
          ...
          a.createElement(
            P1,
            null,
            a.createElement(R1, null, D, a.createElement(lh, { isOutdated: e }))
          ),
          a.createElement(
            i6,
            null,
            oe && a.createElement(Tr, null),
            !oe &&
              _ &&
              a.createElement(
                li,
            ...
            !oe &&
              ...
              a.createElement(
                a.Fragment,
                null,
                a.createElement(l6, null, a.createElement('b', null, 'Error stack trace')),
                a.createElement(o6, null, ge.stack || ge.message)
              )
          ),
          a.createElement(V1, null, a.createElement(A1, null))
        );
      },
      d6 = k(Ll)({ padding: '4px 8px', margin: '0 6px' }),
      c6 = ({ onClose: e }) =>
        a.createElement(
          vs,
          null,
          a.createElement(
            ...
            a.createElement(
              'p',
              null,
              a.createElement(re, { variant: 'outline' }, a.createElement(ds, null), 'Docs'),
              a.createElement(re, { variant: 'outline' }, a.createElement(xc, null), 'Get support')
            )
          )
        );
    k.div(({ theme: e }) => ({
    ...
    var u6 = ({
        ...
        let { settingsVisible: o, warningsVisible: s } = gr(),
          { toggleSettings: d, toggleWarnings: c } = vn(),
          { isRunning: u, startBuild: m, stopBuild: p } = oa(),
          {
            lastBuildOnBranch: v,
          ...
          w = R0(),
          b = Wt(),
          { buildIsReviewable: h, userCanReview: f } = D0(),
          E = !!(!h && g && y && i),
          ...
          V =
            ...
            a.createElement(D7, {
              branch: e,
              dismissBuildError: t,
              localBuildProgress: F || u ? r : void 0,
            ...
            a.createElement(
              ...
              r && X
                ? a.createElement(
                    ...
                    a.createElement(Mr, { localBuildProgress: r })
                  )
                : a.createElement(
                    ne,
                    null,
        ...
        if (b?.tests?.find((ye) => ye.result === 'SKIPPED'))
          return a.createElement(
            pe,
            null,
            V,
        ...
        let { status: oe } = w,
          ge = ['ANNOUNCED', 'PUBLISHED', 'PREPARED'].includes(oe),
          fe = oe === 'FAILED',
          ce = oe === 'PENDING' && (!f || !h);
        return a.createElement(
          pe,
      ...
      m6 = ({
        ...
        let { setAccessToken: o } = Wi(),
          { isRunning: s, startBuild: d } = oa(),
          { disable: c, disableSnapshot: u, docsOnly: m } = Al('chromatic', {}),
          p = () => {
            ...
            return i
              ? i.currentStep === 'error'
                ? a.createElement(
                    a.Fragment,
                    null,
                    a.createElement(B0, { localBuildProgress: i, title: 'Build failed' }),
                    v
                  )
                : a.createElement(Mr, { localBuildProgress: i })
              : v;
          };
        return a.createElement(
          pe,
      ...
      p6 = ({ buildIsReviewable: e, userCanReview: t, onReviewSuccess: n, onReviewError: r }) => {
        let [{ fetching: i }, l] = Is(X3),
          o = K(
            async (c) => {
              try {
          ...
          s = K((c, u = 'SPEC') => o({ status: 'ACCEPTED', testId: c, batch: u }), [o]),
          d = K((c, u = 'SPEC') => o({ status: 'PENDING', testId: c, batch: u }), [o]);
        return {
          isReviewing: i,
          acceptTest: s,
          unacceptTest: d,
...
`),
      f6 = ({ lastBuildOnBranch: e, vtaOnboarding: t }) => {
        ...
        let [{ fetching: v }, g] = Is(h6),
          y = a.useCallback(
            async (h) => {
              (await g({ input: { vtaOnboarding: h ? 'COMPLETED' : 'DISMISSED' } }), p(!0), c(!1));
      ...
      g6 = ({
        ...
        let u = _t(),
          ...
          g = e7({ projectId: s, storyId: c, gitInfo: d, selectedBuildInfo: t }),
          {
            account: y,
            features: w,
            manageUrl: b,
        ...
        te(() => l(!D), [D, l]);
        let ye =
            C && 'testsForStatus' in C && C.testsForStatus?.nodes && an(O0, C.testsForStatus.nodes),
          we = F ? C4(ye || []) : [];
        (te(() => {
          o(we);
        }, [JSON.stringify(we), o]),
          te(() => {
            n((Gt) =>
              S4(Gt, {
                shouldSwitchToLastBuildOnBranch: F && _,
                lastBuildOnBranchId: C?.id,
                storyId: c,
              })
            );
          }, [F, _, C?.id, n, c]));
        let He = K(() => C?.id && F && n({ buildId: C.id, storyId: c }), [n, F, C?.id, c]),
          {
            showOnboarding: je,
            showGuidedTour: K0,
            completeOnboarding: Q0,
            completeWalkthrough: J0,
            skipOnboarding: X0,
            skipWalkthrough: ed,
            startWalkthrough: td,
              ...
              : a.createElement(
                  ...
                  !V || !E || !h || X
                    ? a.createElement(m6, {
                        ...
                        dismissBuildError: r,
                        localBuildProgress: i,
                        ...(F && { switchToLastBuildOnBranch: He }),
                      })
                    : a.createElement(
                        U7,
                        { watchState: ce },
      ...
      v6 = (e) => {
        ...
        return a.createElement(g6, { selectedBuildInfo: t, setSelectedBuildInfo: n, ...e });
      },
      q0 = ({ localBuildProgress: e, accessToken: t }) => {
        let n = va({}),
          r = qt(pr),
          [i, l] = Le(!1),
          [o, s] = Le(!1),
          d = e ? ['initialize', 'build', 'upload'].includes(e?.currentStep) : !1,
          c = e ? !['aborted', 'complete', 'error', 'limited'].includes(e.currentStep) : i,
          u = gt(
            () =>
              yi(
                'startBuild',
                () => {
                  (s(!1), l(!0), n(zd, { accessToken: t }), r?.({ action: 'startBuild' }));
                },
                1e3,
                !1
              ),
      ...
      y6 = () => {
        let e = va({
          [Qd]: (t) => {
            let n = Qt.get(t.requestId);
            if (n)
              if ((Qt.delete(t.requestId), 'error' in t)) n.reject(new Error(t.error));
              else {
        ...
        return async (t, { signal: n, ...r } = {}) => {
          ...
          return (
            n?.addEventListener('abort', () => {
              (e(Yd, { requestId: i }), Qt.get(i)?.reject(n.reason), Qt.delete(i));
            }),
            e(Kd, { requestId: i, input: t, init: r }),
            new Promise((l, o) => {
              (Qt.set(i, { resolve: l, reject: o }),
                setTimeout(() => {
                  (o(new Error('Request timed out')), Qt.delete(i));
                }, 3e4));
            })
          );
        };
      ...
      b6 = ({ active: e }) => {
        let [t, n] = Rs(),
          r = K(
            (je) => {
              (n(je), je || Rc('authenticationScreen', 'exchangeParameters'));
            },
            [n]
          ),
          { storyId: i } = kn(),
          ...
          oe = K((je) => p(Gd, je), [p]),
          {
            ...
            startBuild: fe,
            stopBuild: ce,
          } = q0({ localBuildProgress: c, accessToken: t }),
          ye = y6(),
          we = (je) =>
            a.createElement(
              D2,
              ...
              a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement(
                    Bc,
                    { addonUninstalled: F, setAddonUninstalled: V },
                    a.createElement(
                      ru,
                      null,
                      a.createElement(
                        k4,
                        { watchState: { isRunning: ge, startBuild: fe, stopBuild: ce } },
                        a.createElement(
                          'div',
        ...
        if (!e) return we(null);
        if (globalThis.CONFIG_TYPE !== 'DEVELOPMENT') return we(a.createElement(y4, null));
        if (F) return we(a.createElement(E4, null));
        if (s) return we(a.createElement(b4, { offline: s }));
        if (!t)
          return we(
            a.createElement(Xm, { setAccessToken: r, setCreatedProjectId: _, hasProjectId: !!y })
          );
        if (o || !l) return we(a.createElement(r4, { gitInfoError: o }));
        if (g) return e ? a.createElement(vi, null) : null;
        if (!y)
          return we(
            a.createElement(h4, { createdProjectId: C, setCreatedProjectId: _, onUpdateProject: b })
          );
        if (h) {
          if (!w) throw new Error('Missing config file after configuration failure');
          return we(a.createElement(m4, { projectId: y, configFile: w }));
        }
        if (f) {
          if (!w) throw new Error('Missing config file after configuration success');
          return we(a.createElement(s4, { projectId: y, configFile: w, goToNext: E }));
        }
        let He = l.branch === c?.branch;
        return we(
          a.createElement(v6, {
            dismissBuildError: () => u(void 0),
            isOutdated: !!d,
            localBuildProgress: He ? c : void 0,
            setOutdated: m,
            updateBuildStatus: v,
            projectId: y,
            gitInfo: l,
      ...
      si = ht(zi()),
      E6 = k.div({ display: 'flex', justifyContent: 'space-between', padding: '8px 0' }),
      ...
      N6 = k(pc)({ width: 10 }),
      F6 = () => {
        let { addNotification: e, selectStory: t, setOptions: n, togglePanel: r } = _t(),
          i = Sl(
            (ce) =>
              Object.values(ce)
                .map((ye) => ye[U]?.value)
                .filter((ye) => ye === 'status-value:warning').length
          ),
          l = qt(pr),
          { projectId: o } = Y0(),
          [s] = Rs(),
          ...
          [y] = ke(D1),
          w = be(p?.currentStep),
          { index: b, storyId: h, viewMode: f } = kn(),
          E = xl((ce) => ce[di] ?? 'test-provider-state:pending'),
          { startBuild: C, stopBuild: _ } = q0({ localBuildProgress: p, accessToken: s }),
          F;
        (c && (F = 'Not available offline'),
          g && (F = 'Configuration problem'),
          y && (F = 'Git synchronization problem'),
          d || (F = 'Login required'),
          o || (F = 'Set up visual tests'));
        let V = !F && E !== 'test-provider-state:crashed',
          D = K(() => {
            V && C();
          }, [V, C]);
        te(() => Cl(di).onRunAll(D), [D]);
        let X = K(
            (ce) => {
              if ((n({ selectedPanel: rn }), r(!0), b && f !== 'story')) {
                let ye = Object.keys(b).indexOf(h),
                  we = Object.entries(b).slice(ye > 0 ? ye : 0),
                  [He] = we.find(([, { type: je }]) => je === 'story') || [];
                He && t(He);
              }
        ...
        (te(() => {
          ...
          return (
            ...
            window.addEventListener('online', ye),
            () => {
              (window.removeEventListener('offline', ce), window.removeEventListener('online', ye));
            }
          );
        }, [u]),
          te(() => {
        ...
        switch (!0) {
          case !!F:
            fe = a.createElement(Zt, { onClick: ge }, F);
            break;
          case E === 'test-provider-state:running':
            fe = p ? El[p.currentStep].renderProgress(p) : 'Starting...';
            break;
          case !!m:
          ...
          case p?.currentStep === 'complete':
            fe = p.errorCount
              ? `Encountered ${(0, si.default)('component error', p.errorCount, !0)}`
              : i
                ? `Found ${(0, si.default)('story', i, !0)} with ${(0, si.default)('change', i)}`
              ...
              : E === 'test-provider-state:running'
                ? a.createElement(
                    Ee,
                    {
                      hasChrome: !1,
                      trigger: 'hover',
                      tooltip: a.createElement(ya, { note: 'Stop Visual tests' }),
                    },
                    a.createElement(
                      Sn,
                      {
                        ...
                        padding: 'none',
                        onClick: _,
                        disabled: !['initialize', 'build', 'upload'].includes(p?.currentStep ?? ''),
                      },
                      a.createElement(
                        x6,
                ...
                : a.createElement(
                    Ee,
                    {
                      hasChrome: !1,
                      trigger: 'hover',
                      tooltip: a.createElement(ya, { note: 'Start Visual tests' }),
                    },
                    a.createElement(
                      Sn,
                      {
    ...
    fa.register(U, (e) => {
      (fa.add(rn, {
        ...
        globalThis.CONFIG_TYPE === 'DEVELOPMENT' &&
          ...
          fa.add(di, {
            type: Lr.experimental_TEST_PROVIDER,
            render: () => a.createElement(F6, null),
          })));
    });
  })();
} catch (e) {
