  ...
  (() => {
    ...
    var _d,
      ...
      Mn = pe(() => {
        ...
        Q();
        ee();
        ((_d = __STORYBOOK_ICONS__),
          ({
            AccessibilityAltIcon: Pd,
            AccessibilityIcon: Rd,
            AccessibilityIgnoredIcon: xd,
            AddIcon: Ad,
            AdminIcon: Nd,
            AlertAltIcon: kd,
            AlertIcon: Ld,
            ...
            ChevronSmallLeftIcon: _f,
            ChevronSmallRightIcon: Pf,
    ...
    function Ho(e, t = {}) {
      ...
      ((function (y) {
        ...
        let v = $t('style');
        ((v.dataset.neoconfetti = ''), (v.textContent = y), Vt(document.head, v));
      })(Bo),
        e.classList.add(Wo),
        ...
        R(),
        {
          update(y) {
            ...
            if (v === i) {
              ...
              for (let [tt, { color: Re }] of Zn(d)) {
                let xe = h[+tt];
                (JSON.stringify(n) !== JSON.stringify(z) && xe.style.setProperty('--bgc', Re),
                  w !== a && xe.style.setProperty('--br', g(w, f()) ? '50%' : '0'),
                  I !== c && (c && xe.classList.remove(c), I && xe.classList.add(I)));
              }
            } else Ue = !0;
            (l && !Me && clearTimeout(b),
    ...
    function C(e) {
      ...
      return C.array(e) ? 'Array' : C.plainFunction(e) ? 'Function' : jt(e) || 'Object';
    }
    function ci(...e) {
    ...
    function nr(e, t, n) {
      let { actual: r, key: o, previous: i, type: a } = n,
        s = we(e, o),
        c = we(t, o),
        l = [s, c].every(x.number) && (a === 'increased' ? s < c : s > c);
      return (x.undefined(r) || (l = l && c === r), x.undefined(i) || (l = l && s === i), l);
    }
    function rr(e, t, n) {
      ...
      if (!x.nullOrUndefined(i)) {
        if (x.defined(c)) {
          if (x.array(c) || x.plainObject(c)) return ui(c, l, i);
        } else return oe(l, i);
        return !1;
      }
      return [a, s].every(x.array)
        ? !l.every(un(c))
        : [a, s].every(x.plainObject)
          ? pi(Object.keys(c), Object.keys(l))
          : ![a, s].every((p) => x.primitive(p) && x.defined(p)) &&
            (o === 'added' ? !x.defined(a) && x.defined(s) : x.defined(a) && !x.defined(s));
    }
    function or(e, t, { key: n } = {}) {
      ...
      return ([r, o].every(x.plainObject) && ((r = Object.keys(r)), (o = Object.keys(o))), [r, o]);
    }
    function ir(e) {
      return ([t, n]) =>
        x.array(e)
          ? oe(e, n) || e.some((r) => oe(r, n) || (x.array(n) && un(n)(r)))
          : x.plainObject(e) && e[t]
            ? !!e[t] && oe(e[t], n)
            : oe(e, n);
    }
    ...
    function ar(e) {
      return (t) => (x.array(e) ? e.some((n) => oe(n, t) || (x.array(t) && un(t)(n))) : oe(e, t));
    }
    function ot(e, t) {
      return x.array(e) ? e.some((n) => oe(n, t)) : oe(e, t);
    }
    function un(e) {
    ...
    function we(e, t) {
      return x.plainObject(e) || x.array(e)
        ? x.string(t)
    ...
    function At(e, t) {
      if ([e, t].some(x.nullOrUndefined)) throw new Error('Missing required parameters');
      if (![e, t].every((n) => x.plainObject(n) || x.array(n)))
      ...
      return {
        ...
        changed: (n, r, o) => {
          try {
            ...
            return [i, a].every(x.array) || [i, a].every(x.plainObject) ? !oe(i, a) : i !== a;
          } catch {
            return !1;
          }
        },
        changedFrom: (n, r, o) => {
          if (!x.defined(n)) return !1;
          try {
            let i = we(e, n),
              a = we(t, n),
              s = x.defined(o);
        ...
        decreased: (n, r, o) => {
          if (!x.defined(n)) return !1;
          try {
            return nr(e, t, { key: n, actual: r, previous: o, type: 'decreased' });
          } catch {
            return !1;
          }
        },
        ...
        increased: (n, r, o) => {
          if (!x.defined(n)) return !1;
          try {
            return nr(e, t, { key: n, actual: r, previous: o, type: 'increased' });
          } catch {
            return !1;
          }
        },
    ...
    function qe(e) {
      ...
      return !r || r === 'BODY' || r === 'HTML'
        ...
        : ['TH', 'TD', 'TABLE'].indexOf(n.nodeName) !== -1 && He(n, 'position') === 'static'
          ? qe(n)
          : n;
    }
    function bi(e) {
    ...
    function dn(e, t) {
      ...
      return ((r && !n ? t.contains(s) : t === s && s.nodeName !== 'BODY') && (u = vi(u, t)), u);
    }
    function Si(e) {
    ...
    function Gr(e) {
      ...
      for (var t = e.parentElement; t && He(t, 'transform') === 'none'; ) t = t.parentElement;
    ...
    function fn(e, t, n, r) {
      ...
      if (r === 'viewport') i = Si(a, o);
        ...
        var s = void 0;
        r === 'scrollParent'
          ? ((s = dt(pn(t))), s.nodeName === 'BODY' && (s = e.ownerDocument.documentElement))
          : r === 'window'
    ...
    function Ii() {
      if (!this.state.isDestroyed) {
        ...
        ((e.offsets.reference = qr(
          ...
          (e.offsets.popper = Vr(this.popper, e.offsets.reference, e.placement)),
    ...
    function Zr(e, t, n, r) {
      ...
      (i.addEventListener(t, n, { passive: !0 }), o || Zr(dt(i.parentNode), t, n, r), r.push(i));
    }
    function _i(e, t, n, r) {
      ((n.updateBound = r), Xr(e).addEventListener('resize', n.updateBound, { passive: !0 }));
      var o = dt(e);
      return (
    ...
    function Pi() {
      this.state.eventsEnabled ||
        (this.state = _i(this.reference, this.options, this.state, this.scheduleUpdate));
    }
    function Ri(e, t) {
      return (
    ...
    function xi() {
      this.state.eventsEnabled &&
        (cancelAnimationFrame(this.scheduleUpdate), (this.state = Ri(this.reference, this.state)));
    }
    function mn(e) {
    ...
    function Ni(e) {
      return (
        ...
        e.arrowElement && Object.keys(e.arrowStyles).length && rn(e.arrowElement, e.arrowStyles),
        e
      );
    }
    function ki(e, t, n, r, o) {
      var i = qr(o, t, e, n.positionFixed),
        a = Yr(n.placement, i, t, e, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
      return (
    ...
    function Mi(e, t) {
      ...
      var R = { 'x-placement': e.placement };
      return (
        (e.attributes = ce({}, R, e.attributes)),
    ...
    function Di(e, t) {
      ...
      var g = s[u] + s[l] / 2 - f / 2,
        ...
        R = parseFloat(S['border' + p + 'Width']),
        y = g - e.offsets.popper[u] - b - R;
      return (
        (y = Math.max(Math.min(a[l] - f, y), 0)),
        (e.arrowElement = r),
        (e.offsets.arrow = ((n = {}), Ve(n, u, Math.round(y)), Ve(n, d, ''), n)),
        e
      );
    }
    function Fi(e) {
    ...
    function Gi(e, t) {
      ...
      var r = hn('transform'),
        ...
        s = o[r];
      ((o.top = ''), (o.left = ''), (o[r] = ''));
      var c = fn(e.instance.popper, e.instance.reference, t.padding, n, e.positionFixed);
      ...
      var l = t.priority,
        ...
        u = {
          primary: function (d) {
            var h = p[d];
            return (
              p[d] < c[d] && !t.escapeWithReference && (h = Math.max(p[d], c[d])),
              Ve({}, d, h)
            );
          },
          secondary: function (d) {
            ...
            return (
              p[d] > c[d] &&
                ...
                (f = Math.min(p[h], c[d] - (d === 'right' ? p.width : p.height))),
              Ve({}, h, f)
            );
          },
        };
    ...
    function yr(e, t, n) {
      ...
      return (k.undefined(r) || (l = l && c === r), k.undefined(i) || (l = l && s === i), l);
    }
    function gr(e, t, n) {
      var r = n.key,
        o = n.type,
      ...
      return [a, s].every(k.array)
        ...
        : [a, s].every(k.plainObject)
          ...
          : ![a, s].every(function (p) {
            ...
            }) && (o === 'added' ? !k.defined(a) && k.defined(s) : k.defined(a) && !k.defined(s));
    }
    function br(e, t, n) {
      var r = n === void 0 ? {} : n,
        o = r.key,
      ...
      return ([i, a].every(k.plainObject) && ((i = Object.keys(i)), (a = Object.keys(a))), [i, a]);
    }
    function vr(e) {
      return function (t) {
        var n = t[0],
    ...
    function no() {
      for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
      return e.every(k.array) || e.every(k.number) || e.every(k.plainObject) || e.every(k.string);
    }
    function Te(e, t) {
    ...
    function ya(e, t) {
      if ([e, t].some(k.nullOrUndefined)) throw new Error('Missing required parameters');
      if (
      ...
      var n = function (u, d) {
        ...
        r = function (u, d, h) {
          try {
            var f = Te(e, u),
              ...
              b = k.defined(h);
            if (S || b) {
              var R = b ? it(h, f) : !it(d, f),
                y = it(d, g);
              return R && y;
            }
            return [f, g].every(k.array) || [f, g].every(k.plainObject) ? !ie(f, g) : f !== g;
          } catch {
            return !1;
          }
        },
        ...
        a = function (u, d, h) {
          if (!k.defined(u)) return !1;
          try {
            return yr(e, t, { key: u, actual: d, previous: h, type: 'decreased' });
          } catch {
            return !1;
          }
        },
        ...
        l = function (u, d, h) {
          if (!k.defined(u)) return !1;
          try {
            return yr(e, t, { key: u, actual: d, previous: h, type: 'increased' });
          } catch {
            return !1;
          }
        },
      ...
      var t = e.content,
        ...
        l = {
          content: m.isValidElement(t)
            ? t
            : m.createElement('div', { className: '__floater__content', style: c.content }, t),
        };
      return (
        s &&
          (l.title = m.isValidElement(s)
            ? s
            : m.createElement('div', { className: '__floater__title', style: c.title }, s)),
        n &&
          (l.footer = m.isValidElement(n)
            ? n
            : m.createElement('div', { className: '__floater__footer', style: c.footer }, n)),
        (a || i) &&
          !le.boolean(o) &&
    ...
    function ut(e, t, n) {
      ...
      if (r) {
        ...
        if (!(r.scrollHeight > r.offsetHeight) && !t) return ((r.style.overflow = 'initial'), Be());
      }
      return r;
    }
    function bt(e, t) {
    ...
    function za(e, t, n) {
      var r;
      if (!e) return 0;
      let { offsetTop: o = 0, scrollTop: i = 0 } = (r = (0, Br.default)(e)) != null ? r : {},
    ...
    function Se(e, t = {}) {
      ...
      if (i)
        (i.includes('{step}') || i.includes('{steps}')) &&
          r &&
          o &&
          (i = i.replace('{step}', r.toString()).replace('{steps}', o.toString()));
      else if (Ht(e) && !Object.values(e.props).length && xt(e.type) === 'function') {
        let a = e.type({});
        i = Se(a, t);
    ...
    function Ya(e, t) {
      return !x.plainObject(e) || !x.array(t) ? !1 : Object.keys(e).every((n) => t.includes(n));
    }
    function qa(e) {
    ...
    function ho(e, ...t) {
      if (!x.plainObject(e)) throw new TypeError('Expected an object');
      let n = {};
    ...
    function ln(e, t, n) {
      let r = (i) => i.replace('{step}', String(t)).replace('{steps}', String(n));
      if (xt(e) === 'string') return r(e);
      if (!Ht(e)) return e;
      let { children: o } = e.props;
      if (xt(o) === 'string' && o.includes('{step}')) return Wt(e, { children: r(o) });
      if (Array.isArray(o))
        return Wt(e, { children: o.map((i) => (typeof i == 'string' ? r(i) : ln(i, t, n))) });
      if (xt(e.type) === 'function' && !Object.values(e.props).length) {
        let i = e.type({});
        return ln(i, t, n);
      }
      return e;
    ...
    function es(e, t) {
      ...
      let { floaterProps: s, styles: c } = e,
        l = (0, Pt.default)((n = t.floaterProps) != null ? n : {}, s ?? {}),
        p = (0, Pt.default)(c ?? {}, (r = t.styles) != null ? r : {}),
      ...
      let f = {
        ...
        g = {
          ...
          buttonNext: { ...lt, backgroundColor: u.primaryColor, borderRadius: 4, color: '#fff' },
          buttonBack: { ...lt, color: u.primaryColor, marginLeft: 'auto', marginRight: 5 },
          buttonClose: {
            ...lt,
            color: u.textColor,
            height: 14,
          ...
          overlay: { ...f, backgroundColor: u.overlayColor, mixBlendMode: 'hard-light' },
          overlayLegacy: { ...f },
          overlayLegacyCenter: { ...f, backgroundColor: u.overlayColor },
          spotlight: { ..._r, backgroundColor: 'gray' },
          spotlightLegacy: {
            ..._r,
    ...
    function Ye(e, t) {
      var n, r, o, i, a, s;
      let c = t ?? {},
        l = _t.default.all([Xa, ts(e), c], { isMergeableObject: x.plainObject }),
        p = es(e, l),
        u = bt(Pe(l.target), l.disableScrollParentFix),
        d = _t.default.all([
          Ja,
      ...
      return (
        (d.offset = l.offset),
        (d.styles = (0, _t.default)((o = d.styles) != null ? o : {}, p.floaterStyles)),
        (d.offset +=
        ...
        {
          ...l,
          locale: _t.default.all([mo, (s = e.locale) != null ? s : {}, l.locale || {}]),
          floaterProps: d,
      ...
      return x.plainObject(e)
        ? e.target
          ...
          : (Le({
            ...
            !1)
        : (Le({ title: 'validateStep', data: 'step must be an object', warn: !0, debug: t }), !1);
    }
    function Pr(e, t = !1) {
      return x.array(e)
        ? e.every((n) => yo(n, t))
        : (Le({ title: 'validateSteps', data: 'steps must be an array', warn: !0, debug: t }), !1);
    }
    function rs(e) {
      return new ns(e);
    }
    ...
    function ds(e) {
      ...
      return (
        ...
        (S.close = !u && V(ps, { 'data-test-id': 'button-close', styles: f.buttonClose, ...n })),
        V(
          'div',
          {
            key: 'JoyrideTooltip',
    ...
    function Ps(e) {
      ...
      return !!(
        t &&
        (t.navigator.userAgent.match(/Chromatic/) || t.location.href.match(/chromatic=true/))
      );
    }
    function Ms(e) {
    ...
    function en(e) {
      return Ps() ? e : Object.fromEntries(Ms(Object.entries(e)));
    }
    function Js({ api: e }) {
      let [t, n] = ae(!0),
        [r, o] = ae(!1),
      ...
      if (
        ...
        se(() => {
          a((I) =>
            ['1:Intro', '5:StoryCreated', '6:IntentSurvey', '7:FinishedOnboarding'].includes(I)
              ? I
              : u
                ? '4:CreateStory'
                : l
        ...
        return null;
      let R = h?.sourceFileContent,
        y = R?.lastIndexOf(`export const ${h?.newStoryExportName}`),
        v = R?.slice(y).trim(),
        w = R?.slice(0, y).split(`
`).length,
        U = [
          {
            ...
            content: m.createElement(
              ...
              m.createElement(Qn, { targetSelector: '#control-primary', pulsating: !0 })
            ),
            offset: 20,
            placement: 'right',
            disableBeacon: !0,
              ...
              v &&
                m.createElement(
                  ...
                  m.createElement(
                    ...
                    m.createElement(
                      Rn,
                      { language: 'jsx', showLineNumbers: !0, startingLineNumber: w },
                      v
                    )
                  )
                )
        ...
        ((Co = Object.create),
          ...
          (xo = (e, t, n, r) => {
            if ((t && typeof t == 'object') || typeof t == 'function')
              for (let o of Nr(t))
                !Ro.call(e, o) &&
                  o !== n &&
                  Ar(e, o, { get: () => t[o], enumerable: !(r = _o(t, o)) || r.enumerable });
            return e;
          }),
          (We = (e, t, n) => (
            (n = e != null ? Co(Po(e)) : {}),
            xo(t || !e || !e.__esModule ? Ar(n, 'default', { value: e, enumerable: !0 }) : n, e)
          )),
          (Ao = ue({
          ...
          (cn = ue({
            '../../node_modules/deepmerge/dist/cjs.js'(e, t) {
              ...
              function l(y, v) {
                return v.clone !== !1 && v.isMergeableObject(y) ? b(c(y), y, v) : y;
              }
              function p(y, v, w) {
              ...
              function g(y, v) {
                return (
                  f(y, v) &&
                  !(Object.hasOwnProperty.call(y, v) && Object.propertyIsEnumerable.call(y, v))
                );
              }
              function S(y, v, w) {
                var U = {};
            ...
            '../../node_modules/react-is/cjs/react-is.development.js'(e) {
              (function () {
                var t = typeof Symbol == 'function' && Symbol.for,
                  ...
                  R = t ? Symbol.for('react.responder') : 60118,
              ...
              t.exports = a()
                ...
                : function (s, c) {
                    for (var l, p = i(s), u, d = 1; d < arguments.length; d++) {
                      ...
                      if (n) {
                        u = n(l);
                        for (var f = 0; f < u.length; f++) o.call(l, u[f]) && (p[u[f]] = l[u[f]]);
                      }
                    }
                    return p;
                  };
            ...
            '../../node_modules/prop-types/factoryWithTypeCheckers.js'(e, t) {
              ...
              t.exports = function (l, p) {
                    ...
                    if (!Array.isArray(F)) {
                      ...
                      return new b(
                        'Invalid ' +
                          ...
                          M +
                          '` of type ' +
                          ('`' + Y + '` supplied to `' + j + '`, expected an array.')
                      );
                    }
                ...
                function te(E) {
                  ...
                  function N(W, D, j, G, M) {
                    for (var F = W[D], Y = 0; Y < E.length; Y++) if (S(F, E[Y])) return null;
                    ...
                    if (Y !== 'object')
                      return new b(
                        'Invalid ' +
                          ...
                          M +
                          '` of type ' +
                          ('`' + Y + '` supplied to `' + j + '`, expected an object.')
                      );
                    for (var K in F)
                      if (i(F, K)) {
                        var q = E(F, K, j, G, M + '.' + K, o);
                ...
                function tt(E) {
                  function N(W, D, j, G, M) {
                    ...
                    for (var q in K) {
                      var T = E[q];
                      if (i(E, q) && typeof T != 'function') return Me(j, G, M, q, Ae(T));
                      if (!T)
                        return new b(
                          'Invalid ' +
                            G +
...
Valid keys: ` +
                ...
                function Re(E) {
                  switch (typeof E) {
                    ...
                    case 'boolean':
                      return !E;
                    case 'object':
                      if (Array.isArray(E)) return E.every(Re);
                      ...
                      if (N) {
                        var W = N.call(E),
                          D;
                        if (N !== E.entries) {
                          for (; !(D = W.next()).done; ) if (!Re(D.value)) return !1;
                        } else
                          for (; !(D = W.next()).done; ) {
                            var j = D.value;
                            if (j && !Re(j[1])) return !1;
                          }
                      } else return !1;
                      return !0;
                    default:
        ...
        ((oi = [
          ...
          (ii = ['bigint', 'boolean', 'null', 'number', 'string', 'symbol', 'undefined']));
        li = ['innerHTML', 'ownerDocument', 'style', 'attributes', 'nodeValue'];
        C.array = Array.isArray;
        C.arrayOf = (e, t) => (!C.array(e) && !C.function(t) ? !1 : e.every((n) => t(n)));
        ...
        C.generator = (e) => C.iterable(e) && C.function(e.next) && C.function(e.throw);
        C.generatorFunction = fe('GeneratorFunction');
        C.instanceOf = (e, t) => (!e || !t ? !1 : Object.getPrototypeOf(e) === t.prototype);
        C.iterable = (e) => !C.nullOrUndefined(e) && C.function(e[Symbol.iterator]);
        C.map = fe('Map');
        C.nan = (e) => Number.isNaN(e);
        C.null = (e) => e === null;
        C.nullOrUndefined = (e) => C.null(e) || C.undefined(e);
        C.number = (e) => Je('number')(e) && !C.nan(e);
        C.numericString = (e) => C.string(e) && e.length > 0 && !Number.isNaN(Number(e));
        C.object = (e) => !C.nullOrUndefined(e) && (C.function(e) || typeof e == 'object');
        ...
        ((di = We(Ao(), 1)),
          ...
          (Pt = We(cn(), 1)),
          (O = We(Fo())),
          (pt = typeof window < 'u' && typeof document < 'u' && typeof navigator < 'u'),
          (fi = (function () {
        ...
        ((eo = [
          ...
          (Xt = eo.slice(3)));
        Zt = { FLIP: 'flip', CLOCKWISE: 'clockwise', COUNTERCLOCKWISE: 'counterclockwise' };
        ((Vi = {
          ...
          applyStyle: { order: 900, enabled: !0, fn: Ni, onLoad: ki, gpuAcceleration: void 0 },
        }),
          (Ki = {
            placement: 'bottom',
            positionFixed: !1,
          ...
          (Mt = (function () {
            function e(t, n) {
              ...
              (Ei(this, e),
                ...
                Object.keys(ce({}, e.Defaults.modifiers, o.modifiers)).forEach(function (a) {
        ...
        ((fr = Mt),
          ...
          (Zi = ['bigint', 'boolean', 'null', 'number', 'string', 'symbol', 'undefined']));
        ...
        _.asyncFunction = he('AsyncFunction');
        _.bigint = Ze('bigint');
        ...
        _.primitive = function (e) {
          return _.null(e) || ea(typeof e);
        };
        _.promise = he('Promise');
        ...
        _.string = Ze('string');
        _.symbol = Ze('symbol');
        _.undefined = Ze('undefined');
        _.weakMap = he('WeakMap');
        _.weakSet = he('WeakSet');
        le = _;
        ((ta = to('function')),
          (na = function (e) {
            return e === null;
        ...
        ((la = ['innerHTML', 'ownerDocument', 'style', 'attributes', 'nodeValue']),
          (ca = [
            'Array',
            'ArrayBuffer',
            'AsyncFunction',
          ...
          (ua = ['bigint', 'boolean', 'null', 'number', 'string', 'symbol', 'undefined']));
        ...
        P.asyncFunction = me('AsyncFunction');
        P.bigint = Qe('bigint');
        ...
        P.empty = function (e) {
          return (
            ...
            (P.object(e) && !P.map(e) && !P.set(e) && Object.keys(e).length === 0) ||
            (P.set(e) && e.size === 0) ||
            (P.map(e) && e.size === 0)
          );
        };
        P.error = me('Error');
        P.function = Qe('function');
        P.generator = function (e) {
          return P.iterable(e) && P.function(e.next) && P.function(e.throw);
        };
        P.generatorFunction = me('GeneratorFunction');
        ...
        P.string = Qe('string');
        P.symbol = Qe('symbol');
        P.undefined = Qe('undefined');
        P.weakMap = me('WeakMap');
        P.weakSet = me('WeakSet');
        k = P;
        ((Oa = { flip: { padding: 20 }, preventOverflow: { padding: 10 } }),
          ...
          (wa = 'The error message is optional, but must be a string if provided.'));
        ((H = {
          INIT: 'init',
          IDLE: 'idle',
          OPENING: 'opening',
            ...
            mt(n, [
              {
                ...
                value: function () {
                  Oe() && (this.node || this.appendNode(), at || this.renderPortal());
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var r = this.props,
                    o = r.children,
                    i = r.setRef;
                  if ((this.node || this.appendNode(), at)) return Fe.createPortal(o, this.node);
                      ...
                      (a.startsWith('top')
                        ...
                        : a.startsWith('bottom')
                          ...
                          : a.startsWith('left')
                            ...
                            : a.startsWith('right') && (b.padding = '0 0 0 '.concat(p, 'px'))),
                    [H.OPENING, H.OPEN].indexOf(c) !== -1 && (b = X(X({}, b), f)),
                ...
                value: function () {
                  ...
                  if (o)
                    if (m.Children.count(o) === 1)
                      if (!m.isValidElement(o)) d = m.createElement('span', null, o);
                      else {
          ...
          (gn = (function (e) {
            ...
            function n(r) {
              ...
              return (
                ht(this, n),
                (o = t.call(this, r)),
                re(_e(o), 'setArrowRef', function (i) {
                  o.arrowRef = i;
                }),
                re(_e(o), 'setChildRef', function (i) {
                  o.childRef = i;
                }),
                re(_e(o), 'setFloaterRef', function (i) {
                  o.floaterRef = i;
                }),
                re(_e(o), 'setWrapperRef', function (i) {
                  o.wrapperRef = i;
                }),
                re(_e(o), 'handleTransitionEnd', function () {
                  var i = o.state.status,
                    a = o.props.callback;
                  (o.wrapperPopper && o.wrapperPopper.instance.update(),
                    o.setState({ status: i === H.OPENING ? H.OPEN : H.IDLE }, function () {
                      var s = o.state.status;
                      a(s === H.OPEN ? 'open' : 'close', o.props);
                    }));
                }),
                re(_e(o), 'handleClick', function () {
                  var i = o.props,
                    a = i.event,
                    s = i.open;
                  if (!le.boolean(s)) {
                    ...
                    (o.event === 'click' || (o.event === 'hover' && l)) &&
                      (Rt({
                        title: 'click',
                        data: [{ event: a, status: p === H.OPEN ? 'closing' : 'opening' }],
                        debug: o.debug,
                      }),
                      o.toggle());
                  }
                }),
                re(_e(o), 'handleMouseEnter', function () {
                  var i = o.props,
                    a = i.event,
                    s = i.open;
                  if (!(le.boolean(s) || Qt())) {
                ...
                re(_e(o), 'handleMouseLeave', function () {
                  var i = o.props,
                    a = i.event,
                    s = i.eventDelay,
                    c = i.open;
              ...
              mt(n, [
                ...
                },
                {
                  ...
                  value: function (r, o) {
                    if (Oe()) {
                      ...
                      if (r.open !== s) {
                        var h;
                        (le.boolean(s) && (h = s ? H.OPENING : H.CLOSING), this.toggle(h));
                      }
                      ((r.wrapperOptions.position !== l.position || r.target !== c) &&
                        this.changeWrapperPosition(this.props),
                        d('status', H.IDLE) && s
                          ? this.toggle(H.OPEN)
                          : u('status', H.INIT, H.IDLE) && a && this.toggle(H.OPEN),
                        this.popper && d('status', H.OPENING) && this.popper.instance.update(),
                        this.floaterRef &&
                          (d('status', H.OPENING) || d('status', H.CLOSING)) &&
                          xa(this.floaterRef, 'transitionend', this.handleTransitionEnd),
                  ...
                  value: function () {
                    ...
                    if (u === 'center') this.setState({ status: H.IDLE });
                      ...
                      new fr(o, this.floaterRef, {
                        ...
                        modifiers: X(
                          {
                            arrow: X({ enabled: !l, element: this.arrowRef }, g),
                        ...
                        onCreate: function (v) {
                          ...
                          if (
                            ((r.popper = v),
                            !((w = r.floaterRef) !== null && w !== void 0 && w.isConnected))
                          ) {
                          ...
                          (c(v, 'floater'),
                            r._isMounted &&
                              r.setState({ currentPlacement: v.placement, status: H.IDLE }),
                            u !== v.placement &&
                              setTimeout(function () {
                                v.instance.update();
                              }, 1));
                    ...
                    if (i) {
                      ...
                      new fr(this.target, this.wrapperRef, {
                        ...
                        onCreate: function (v) {
                          ((r.wrapperPopper = v),
                            r._isMounted && r.setState({ statusWrapper: H.IDLE }),
                            c(v, 'wrapper'),
                            u !== v.placement &&
                              setTimeout(function () {
                                v.instance.update();
                ...
                },
                {
                  ...
                  get: function () {
                    ...
                    return (
                      r || (Oe() && 'ReactFloaterDebug' in window && !!window.ReactFloaterDebug)
                    );
                  },
                },
                {
        ...
        re(gn, 'propTypes', {
          ...
          children: O.default.node,
          component: wr(O.default.oneOfType([O.default.func, O.default.element]), function (e) {
            return !e.content;
          }),
        ...
        ((Ja = {
          ...
          (_r = { borderRadius: 4, position: 'absolute' }));
        ((go = {
          action: 'init',
          controlled: !1,
          index: 0,
            ...
            constructor(e) {
              (A(this, 'beaconPopper'),
                ...
                A(this, 'open', () => {
                  ...
                  o === B.RUNNING &&
                    this.setState({
                      ...this.getNextState({ action: $.UPDATE, lifecycle: L.TOOLTIP }),
                    });
                }),
                A(this, 'prev', () => {
                  let { index: o, status: i } = this.getState();
                ...
                A(this, 'skip', () => {
                  let { status: o } = this.getState();
                  o === B.RUNNING &&
                    this.setState({ action: $.SKIP, lifecycle: L.INIT, status: B.SKIPPED });
                }),
                A(this, 'start', (o) => {
                  let { index: i, size: a } = this.getState();
                  this.setState({
                    ...this.getNextState({ action: $.START, index: x.number(o) ? o : i }, !0),
                ...
                A(this, 'update', (o) => {
                  var i, a;
                  if (!Ya(o, Rr))
                    throw new Error(`State is not valid. Valid keys: ${Rr.join(', ')}`);
                  this.setState({
                    ...this.getNextState(
                      {
                        ...this.getState(),
              ...
              (this.setState(
                {
                  action: $.INIT,
                  controlled: x.number(n),
                  continuous: t,
                  index: x.number(n) ? n : 0,
                  lifecycle: L.INIT,
                  origin: null,
          ...
          (as = class extends De {
            constructor() {
              (super(...arguments),
                ...
                A(this, 'scrollParent'),
                A(this, 'state', { isScrolling: !1, mouseOverSpotlight: !1, showSpotlight: !0 }),
            ...
            componentDidUpdate(e) {
              ...
              (a('lifecycle', L.TOOLTIP) &&
                ...
                (a('spotlightClicks') || a('disableOverlay') || a('lifecycle')) &&
                  (o && r === L.TOOLTIP
            ...
            get overlayStyles() {
              let { mouseOverSpotlight: e } = this.state,
                ...
                o = r.overlay;
              return (
                Cr() && (o = n === 'center' ? r.overlayLegacyCenter : r.overlayLegacy),
                {
            ...
            render() {
              ...
              if (fo() === 'safari') {
                ...
                ((a = V('div', { style: { ...l } }, a)), delete o.backgroundColor);
              }
              return V(
                'div',
                {
      ...
      `)
            ...
            componentDidMount() {
              ...
              (x.domElement(this.beacon) || console.warn('beacon is not a valid DOM element'),
                setTimeout(() => {
        ...
        ((fs = ds),
          ...
          (ms = class extends De {
            ...
            componentDidMount() {
              ...
              Le({ title: `step:${t}`, data: [{ key: 'props', value: this.props }], debug: e });
            }
            componentDidUpdate(e) {
              var t;
              let {
                ...
                R = f('action') || f('index') || f('lifecycle') || f('status'),
              ...
              if (
                ...
                let U = Pe(d.target),
                  I = !!U;
                I && Ha(U)
                  ? (g('status', B.READY, B.RUNNING) || g('lifecycle', L.INIT, L.READY)) &&
                    r({ ...S, step: d, type: de.STEP_BEFORE })
                  : (console.warn(I ? 'Target not visible' : 'Target not mounted', d),
              ...
              (g('lifecycle', L.INIT, L.READY) &&
                ...
                f('index') &&
                  Le({ title: `step:${l}`, data: [{ key: 'props', value: this.props }], debug: a }),
                f('lifecycle', L.BEACON) && r({ ...S, step: d, type: de.BEACON }),
                f('lifecycle', L.TOOLTIP) &&
                  (r({ ...S, step: d, type: de.TOOLTIP }),
                  p &&
                    this.tooltip &&
                    ((this.scope = new ls(this.tooltip, { selector: '[data-action=primary]' })),
                    this.scope.setFocus())),
                g('lifecycle', [L.TOOLTIP, L.INIT], L.INIT) &&
                  ((t = this.scope) == null || t.removeScope(), h.cleanupPoppers()));
            }
            componentWillUnmount() {
              var e;
          ...
          (bo = class extends De {
              ...
              (super(e),
                ...
                A(this, 'handleClickOverlay', () => {
                  let { index: a } = this.state,
                    { steps: s } = this.props;
                  Ye(this.props, s[a]).disableOverlayClose || this.helpers.close('overlay');
                }),
                A(this, 'syncState', (a) => {
                  this.setState(a);
                }));
              let { debug: t, getHelpers: n, run: r = !0, stepIndex: o } = e;
              ((this.store = rs({ ...e, controlled: r && x.number(o) })),
            ...
            componentDidUpdate(e, t) {
              if (!Ne()) return;
              let { action: n, controlled: r, index: o, status: i } = this.state,
                { debug: a, run: s, stepIndex: c, steps: l } = this.props,
                { stepIndex: p, steps: u } = e,
                { reset: d, setSteps: h, start: f, stop: g, update: S } = this.store,
                { changed: b } = At(e, this.props),
                { changed: R, changedFrom: y } = At(t, this.state),
                v = Ye(this.props, l[o]),
                w = !oe(u, l),
                U = x.number(c) && b('stepIndex'),
                I = Pe(v.target);
              if (
                (w && (Pr(l, a) ? h(l) : console.warn('Steps are not valid', l)),
                b('run') && (s ? f(c) : g()),
                U)
              ) {
                let te = x.number(p) && p < c ? $.NEXT : $.PREV;
                (n === $.STOP && (te = $.START),
                  [B.FINISHED, B.SKIPPED].includes(i) ||
                    S({ action: n === $.CLOSE ? $.CLOSE : te, index: c, lifecycle: L.INIT }));
              }
              !r &&
                i === B.RUNNING &&
                o === 0 &&
                ...
                this.callback({ ...this.state, type: de.TARGET_NOT_FOUND, step: v }));
              let z = { ...this.state, index: o, step: v };
              if (R('action', [$.NEXT, $.PREV, $.SKIP, $.CLOSE]) && R('status', B.PAUSED)) {
              ...
              if (R('status', [B.FINISHED, B.SKIPPED])) {
                let te = Ye(this.props, l[t.index]);
                (r ||
                  this.callback({
                    ...z,
                  ...
                  this.callback({ ...z, type: de.TOUR_END, step: te, index: t.index }),
                  d());
              } else
                y('status', [B.IDLE, B.READY], B.RUNNING)
                  ? this.callback({ ...z, type: de.TOUR_START })
                  : (R('status') || R('action', $.RESET)) &&
            ...
            scrollToStep(e) {
              ...
              if (r === B.RUNNING && d) {
                ...
                if (n === L.BEACON && S) {
                  let { offsets: R, placement: y } = S;
                  !['bottom'].includes(y) && !h && (g = Math.floor(R.popper.top - s));
                } else if (n === L.TOOLTIP && b) {
                  let { flipped: R, offsets: y, placement: v } = b;
                  ['top', 'right', 'left'].includes(v) && !R && !h
                ...
                ((g = g >= 0 ? g : 0),
                  r === B.RUNNING &&
                    Ga(g, { element: f, duration: a }).then(() => {
                      setTimeout(() => {
                        var R;
                        (R = this.store.getPopper('tooltip')) == null || R.instance.update();
                      }, 10);
                    }));
              }
            }
            render() {
              ...
              return V('div', { className: 'react-joyride' }, l.step, l.overlay);
            }
          }));
...
`),
          (bs = En(function ({ children: e, onClick: t, variant: n = 'primary', ...r }, o) {
            return m.createElement(gs, { ref: o, onClick: t, variant: n, ...r }, e);
          })),
          (vs = J.div`
  padding: 15px;
  border-radius: 5px;
...
`),
            ...
            let [n, r] = ae(!1),
              ...
              a = (c, l, p) => {
                ...
                i((d) => {
                  ...
                  if (u.type === 'select') {
                    let h = Object.fromEntries(Object.entries(u.values).map(([f]) => [f, f === l]));
                    return { ...d, [c]: { ...u, values: h } };
                  }
                  return d;
                });
              ...
              m.createElement(
                Tt,
                {
                  onSubmit: (c) => {
                    s &&
                      (c.preventDefault(),
                      r(!0),
                      e(Object.fromEntries(Object.entries(o).map(([l, p]) => [l, p.values]))));
                  },
                ...
                m.createElement(
                      ...
                      l.type === 'select' &&
                        m.createElement(
                          Tt.Select,
                          {
                            name: c,
                            id: c,
                            value: Object.entries(l.values).find(([, p]) => p)?.[0] || '',
                            required: l.required,
                            disabled: n,
                          ...
                          Object.entries(l.options).map(([p, u]) =>
                            m.createElement('option', { key: p, value: p }, u.label)
                          )
                        )
                    );
                  }),
                  m.createElement(
                    ...
                    m.createElement(
                      _n,
                      { disabled: n || !s, size: 'medium', type: 'submit', variant: 'solid' },
                      'Submit'
                    )
                  )
                )
    ...
    radial-gradient(circle at 75% 75%, #fc521f99 0%, #fc521f77 18%, transparent 30%)`,
      ...
      radial-gradient(circle at 75% 75%, #fc521f99 0%, #fc521f77 8%, transparent 20%)`,
          ...
          (Us = J.div(({ visible: e }) => ({
            ...
            h1: { fontSize: 45, fontWeight: 'bold', animation: `${vo} 1.5s 1s backwards` },
          }))),
          (zs = J.div({
            display: 'flex',
            marginTop: 40,
            ...
            return (
              ...
              m.createElement(
                ...
                m.createElement(
                  Us,
                  { visible: o },
                  m.createElement('h1', null, 'Meet your new frontend workshop'),
                  m.createElement(
                    zs,
                    null,
                    m.createElement(
    ...
    var tu = __STORYBOOK_API__,
      {
        ...
        merge: _u,
        mockChannel: Pu,
        optionOrAltSymbol: Ru,
        shortcutMatchesShortcut: xu,
    ...
    Cn.register('@storybook/addon-onboarding', async (e) => {
      ...
      e.once(In, () => {
        ...
        (e.togglePanel(!0), e.togglePanelPosition('bottom'), e.setSelectedPanel(wt));
